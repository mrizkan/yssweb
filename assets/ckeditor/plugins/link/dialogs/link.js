...
(function () {
    CKEDITOR.dialog.add("link", function (e) {
        var m = CKEDITOR.plugins.link, p, q = function () {
                var a = this.getDialog(), b = a.getContentElement("target", "popupFeatures"),
                    a = a.getContentElement("target", "linkTargetName"), n = this.getValue();
            ...
            }, c = e.lang.common, b = e.lang.link, g;
        return {
            title: b.title, minWidth: 350, minHeight: 230, contents: [{
                id: "info", label: b.info, title: b.info, elements: [{
                    type: "text", id: "linkDisplayText", label: b.displayText, setup: function () {
                        this.enable();
                    ...
                    onChange: function () {
                        var a = this.getDialog(), b = ["urlOptions", "anchorOptions", "emailOptions"],
                            n = this.getValue(), d = a.definition.getContents("upload"), d = d && d.hidden;
                        "url" == n ? (e.config.linkShowTargetTab && a.showPage("target"), d || a.showPage("upload")) :
                            (a.hidePage("target"), d || a.hidePage("upload"));
                    ...
                    type: "vbox", id: "urlOptions", children: [{
                        type: "hbox", widths: ["25%", "75%"], children: [{
                            ...
                            label: c.protocol,
                            "default": "http://",
                            items: [["http://‎", "http://"], ["https://‎", "https://"], ["ftp://‎",
                            ...
                            type: "text", id: "url", label: c.url, required: !0, onLoad: function () {
                                ...
                                var a = this.getDialog().getContentElement("info", "protocol"), b = this.getValue(),
                                    c = /^((javascript:)|[#\/\.\?])/i, d = /^(http|https|ftp|news):\/\/(?=.)/i.exec(b);
                                d ? (this.setValue(b.substr(d[0].length)),
                                    a.setValue(d[0].toLowerCase())) : c.test(b) && a.setValue("");
                                this.allowOnChange = !0
                            }, onChange: function () {
                    ...
                    type: "vbox", id: "anchorOptions", width: 260, align: "center", padding: 0, children: [{
                        ...
                        html: '\x3cdiv role\x3d"note" tabIndex\x3d"-1"\x3e' + CKEDITOR.tools.htmlEncode(b.noAnchors) +
                        "\x3c/div\x3e",
                        focus: !0,
                        setup: function () {
                ...
                id: "target", requiredContent: "a[target]", label: b.target, title: b.target, elements: [{
                    type: "hbox", widths: ["50%", "50%"], children: [{
                        ...
                        "default": "notSet",
                        style: "width : 100%;",
                        items: [[c.notSet, "notSet"], [b.targetFrame, "frame"], [b.targetPopup, "popup"], [c.targetNew, "_blank"], [c.targetTop,
                            "_top"], [c.targetSelf, "_self"], [c.targetParent, "_parent"]],
                        onChange: q,
                        setup: function (a) {
                    ...
                    type: "vbox", width: "100%", align: "center",
                    padding: 2, id: "popupFeatures", children: [{
                        type: "fieldset",
                        ...
                        children: [{
                            ...
                            children: [{
                                ...
                                setup: h,
                                commit: k
                            }, {type: "checkbox", id: "status", label: b.popupStatusBar, setup: h, commit: k}]
                        }, {
                            type: "hbox",
                            children: [{
                                type: "checkbox",
                                ...
                                setup: h,
                                commit: k
                            }, {type: "checkbox", id: "toolbar", label: b.popupToolbar, setup: h, commit: k}]
                        }, {
                            type: "hbox", children: [{
                                type: "checkbox", id: "menubar", label: b.popupMenuBar, setup: h,
                                commit: k
                            ...
                            children: [{
                                ...
                                setup: h,
                                commit: k
                            }, {type: "checkbox", id: "dependent", label: b.popupDependent, setup: h, commit: k}]
                        }, {
                            type: "hbox",
                            children: [{
                                type: "text",
                ...
                label: b.advanced, title: b.advanced, elements: [{
                    ...
                    type: "vbox", padding: 1, children: [{
                        type: "hbox", widths: ["45%", "55%"], children: [{
                            type: "text", label: b.advisoryTitle, requiredContent: "a[title]",
                            "default": "", id: "advTitle", setup: f, commit: l
                        }, {
                            type: "text",
                        ...
                        type: "hbox", widths: ["45%", "55%"], children: [{
                            type: "text", label: b.rel, requiredContent: "a[rel]",
                            "default": "", id: "advRel", setup: f, commit: l
                        }, {
                            type: "text",
                            label: b.styles,
                            requiredContent: "a{cke-xyz}",
                ...
                if (this._.selectedElement) {
                    ...
                    if (a.linkText && p != a.linkText) f = a.linkText; else if (g == h || "email" == a.type && -1 != h.indexOf("@")) f = "email" == a.type ? a.email.address :
