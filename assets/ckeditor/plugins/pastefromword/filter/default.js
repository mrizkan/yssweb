...
(function () {
    function C(a) {
        a = a.toUpperCase();
        for (var c = D.length, b = 0, f = 0; f < c; ++f)for (var d = D[f],
                                                                 e = d[1].length; a.substr(0, e) == d[1]; a = a.substr(e))b += d[0];
        return b
    }
    ...
    function E(a) {
        a = a.toUpperCase();
        for (var c = 1,
                 b = 1; 0 < a.length; b *= 26)c += "ABCDEFGHIJKLMNOPQRSTUVWXYZ".indexOf(a.charAt(a.length - 1)) * b, a = a.substr(0, a.length - 1);
        return c
    }

    var F = CKEDITOR.htmlParser.fragment.prototype, r = CKEDITOR.htmlParser.element.prototype;
    ...
    r.removeAnyChildWithName =
        function (a) {
            for (var c = this.children, b = [], f,
                     d = 0; d < c.length; d++)f = c[d], f.name && (f.name == a && (b.push(f), c.splice(d--, 1)), b = b.concat(f.removeAnyChildWithName(a)));
            return b
        };
    ...
    F.firstChild = r.firstChild = function (a) {
        for (var c,
                 b = 0; b < this.children.length; b++)if (c = this.children[b], a(c) || c.name && (c = c.firstChild(a)))return c;
        return null
    };
    ...
    var G = /^(?:\b0[^\s]*\s*){1,4}$/, B = {
        ...
        w = 0, x = null, A, H = CKEDITOR.plugins.pastefromword = {
            utils: {
                createListBulletMarker: function (a, c) {
                    ...
                    if ((b = a.removeAnyChildWithName("cke:listbullet")) && b.length && (b = b[0]))return a.name = "cke:li", c.style && (c.style = H.filters.stylesFilter([["text-indent"], ["line-height"], [/^margin(:?-left)?$/, null, function (a) {
                            a =
                                a.split(" ");
                        ...
                        }]])(c.style, a) || ""), c["cke:indent"] || (x = 0, c["cke:indent"] = 1), CKEDITOR.tools.extend(c, b.attributes), !0;
                    A = x = w = null;
                    return !1
                ...
                flattenList: function (a, c) {
                    ...
                    for (var d = a.children, e, k = 0; k < d.length; k++)if (e = d[k], e.name in CKEDITOR.dtd.$listItem) {
                        ...
                        H.filters.stylesFilter([["tab-stops", null, function (a) {
                            (a = a.match(/0$|\d+\.?\d*\w+/)) && (x = CKEDITOR.tools.convertToPx(a[0]))
                    ...
                    var c = a.children, b, f, d, e, k, l;
                    a = [];
                    for (var g, n, h, p, m, t,
                             q = 0; q < c.length; q++)if (b = c[q], "cke:li" == b.name)if (b.name = "li", f = b.attributes, h = (h = f["cke:listsymbol"]) && h.match(/^(?:[(]?)([^\s]+?)([.)]?)$/),
                            p = m = t = null, f["cke:ignored"]) c.splice(q--, 1); else {
                        f["cke:reset"] && (l = e = k = null);
                        d = Number(f["cke:indent"]);
                        d != e && (n = g = null);
                        if (h) {
                            if (n && B[n][g].test(h[1])) p = n, m = g; else for (var u in B)for (var y in B[u])if (B[u][y].test(h[1]))if ("ol" == u && /alpha|roman/.test(y)) {
                                if (g = /roman/.test(y) ? C(h[1]) : E(h[1]), !t || g < t) t = g, p = u, m = y
                            } else {
                                p = u;
                                m = y;
                                break
                            ...
                            !p && (p = h[2] ? "ol" : "ul")
                        } else p = f["cke:listtype"] || "ol", m = f["cke:list-style-type"];
                        n = p;
                        g = m || ("ol" == p ? "decimal" : "disc");
                        m && m != ("ol" == p ? "decimal" : "disc") && b.addStyle("list-style-type",
                            m);
                        if ("ol" == p && h) {
                            switch (m) {
                                case "decimal":
                        ...
                        if (l) {
                            if (d > e) a.push(l = new CKEDITOR.htmlParser.element(p)), l.add(b), k.add(l); else {
                                if (d < e) {
                                    e -= d;
                            ...
                            c.splice(q--, 1)
                        } else a.push(l = new CKEDITOR.htmlParser.element(p)), l.add(b), c[q] = l;
                        k = b;
                        e = d
                    } else l && (l = e = k = null);
                    for (q = 0; q < a.length; q++)if (l = a[q], u = l.children, g = g = void 0, y = l.children.length,
                            v = g = void 0, c = /list-style-type:(.*?)(?:;|$)/, e = CKEDITOR.plugins.pastefromword.filters.stylesFilter, g = l.attributes, !c.exec(g.style)) {
                        ...
                        if (v) {
                            for (k = 0; k < y; k++)g = u[k].attributes, g.style && (g.style = e([["list-style-type"]])(g.style) || "");
                    ...
                    return function (b, f) {
                        ...
                        (b || "").replace(/&quot;/g, '"').replace(/\s*([^ :;]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function (b, e, g) {
                            ...
                            for (var n, h, p,
                                     m = 0; m < a.length; m++)if (a[m] && (b = a[m][0], n = a[m][1], h = a[m][2], p = a[m][3], e.match(b) && (!n || g.match(n)))) {
                                e = p || e;
                                c && (h = h || g);
                    ...
                    return a ? function (f, d) {
                        var e = new CKEDITOR.htmlParser.element(null), k = {};
                        k[c] = f;
                        b(a, k)(e);
                ...
                var b = CKEDITOR.dtd, f = CKEDITOR.tools.extend({}, b.$block, b.$listItem, b.$tableContent), d = a.config,
                    e = this.filters, k = e.falsyFilter, l = e.stylesFilter, g = e.elementMigrateFilter,
                    n = CKEDITOR.tools.bind(this.filters.styleMigrateFilter, this.filters),
                    h = this.utils.createListBulletMarker, p = e.flattenList, m =
                        e.assembleList, t = this.utils.isListBulletIndicator, q = this.utils.isContainingOnlySpaces,
                    u = this.utils.resolveList, y = function (a) {
                        a = CKEDITOR.tools.convertToPx(a);
                        return isNaN(a) ? a : a + "px"
                    }, v = this.utils.getStyleComponents, x = this.utils.listDtdParents,
                    r = !1 !== d.pasteFromWordRemoveFontStyles, w = !1 !== d.pasteFromWordRemoveStyles;
                return {
                    ...
                    elements: {
                        ...
                        $: function (a) {
                            var z =
                                a.name || "", e = a.attributes;
                            z in f && e.style && (e.style = l([[/^(:?width|height)$/, null, y]])(e.style) || "");
                            if (z.match(/h\d/)) {
                                a.filterChildren(c);
                                if (u(a))return;
                                g(d["format_" + z])(a)
                            } else if (z in b.$inline) a.filterChildren(c), q(a) && delete a.name; else if (-1 != z.indexOf(":") && -1 == z.indexOf("cke")) {
                                a.filterChildren(c);
                                if ("v:imagedata" == z) {
                        ...
                        style: function (a) {
                            if (CKEDITOR.env.gecko) {
                                a = (a = a.onlyChild().value.match(/\/\* Style Definitions \*\/([\s\S]*?)\/\*/)) &&
                                    a[1];
                                var c = {};
                                a && (a.replace(/[\n\r]/g, "").replace(/(.+?)\{(.+?)\}/g, function (a, b, I) {
                                    b = b.split(",");
                                    a = b.length;
                                    for (var d = 0; d < a; d++)CKEDITOR.tools.trim(b[d]).replace(/^(\w+)(\.[\w-]+)?$/g, function (a, b, d) {
                                        b = b || "*";
                        ...
                        p: function (a) {
                            if (/MsoListParagraph/i.exec(a.attributes["class"]) ||
                                a.getStyle("mso-list") && !a.getStyle("mso-list").match(/^(none|skip)$/i)) {
                        ...
                        div: function (a) {
                            ...
                            if (c && "table" == c.name) {
                                var b = a.attributes;
                                c.attributes = CKEDITOR.tools.extend(c.attributes,
                                    b);
                        ...
                        font: function (a) {
                            if (t(a.parent)) delete a.name; else {
                                ...
                                "font" == e.name ? (CKEDITOR.tools.extend(e.attributes, a.attributes), d && e.addStyle(d), delete a.name) : (d = (d || "").split(";"), b.color && ("#000000" != b.color && d.push("color:" + b.color), delete b.color), b.face &&
                        ...
                        span: function (a) {
                            ...
                            if (t(a)) {
                                ...
                                if (e)return b = h(e, b), (a = a.getAncestor("span")) && / mso-hide:\s*all|display:\s*none /.test(a.attributes.style) &&
                        ...
                        style: l(w ? [[/^list-style-type$/, null], [/^margin$|^margin-(?!bottom|top)/,
                            null, function (a, b, c) {
                                if (b.name in {p: 1, div: 1}) {
                                    ...
                                    if ("margin" == c) a = v(c, a, [b])[b]; else if (c != b)return null;
                            ...
                            if (CKEDITOR.env.gecko)return a.replace(/-moz-use-text-color/g,
                                "transparent")
