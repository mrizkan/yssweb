...
(function () {
        ...
        return {
            define: function (b, d) {
                ...
                if (0 > e.getListenerIndex(d)) {
                    ...
                    m.fn = d;
                    m.priority = l;
                    for (var r = e.length - 1; 0 <= r; r--)if (e[r].priority <= l)return e.splice(r + 1, 0, m), {removeListener: u};
                    e.unshift(m)
                }
            ...
            once: function () {
                ...
                return function (l, m, u) {
                    ...
                    if (e) {
                        var r = e.listeners;
                        if (r.length)for (var r = r.slice(0), x, D = 0; D < r.length; D++) {
                            if (e.errorProof)try {
                                x =
                                    r[D].call(this, u, m, b, k)
                            } catch (q) {
                            } else x = r[D].call(this, u, m, b, k);
                            !1 === x ? g = 1 : "undefined" != typeof x && (m = x);
                            if (a || g)break
                        }
                    }
    ...
    (function () {
        var a = [], d = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
            b = /&/g, c = />/g, f = /</g, g = /"/g, k = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, l = {
                lt: "\x3c",
                gt: "\x3e",
                amp: "\x26",
                quot: '"',
                ...
                return "#" == e[0] ? String.fromCharCode(parseInt(e.slice(1), 10)) : l[e]
            };
        ...
        CKEDITOR.tools = {
            ...
            buildStyleHtml: function (a) {
                ...
                for (var e,
                         b = [],
                         c = 0; c < a.length; c++)if (e = a[c]) /@import|[{}]/.test(e) ? b.push("\x3cstyle\x3e" + e + "\x3c/style\x3e") : b.push('\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + e + '"\x3e');
                return b.join("")
            },
            ...
            transformPlainTextToHtml: function (a, e) {
                var b = e == CKEDITOR.ENTER_BR, c = this.htmlEncode(a.replace(/\r\n/g, "\n")),
                    c = c.replace(/\t/g, "\x26nbsp;\x26nbsp; \x26nbsp;"), l = e == CKEDITOR.ENTER_P ? "p" : "div";
                if (!b) {
                    var d = /\n{2}/g;
                    if (d.test(c))var q = "\x3c" + l + "\x3e", m = "\x3c/" + l + "\x3e",
            ...
            getUniqueId: function () {
                for (var a = "e",
                         e = 0; 8 > e; e++)a += Math.floor(65536 * (1 + Math.random())).toString(16).substring(1);
                return a
            },
            ...
            createClass: function (a) {
                var e = a.$, b = a.base, c = a.privates || a._, l = a.proto;
                a = a.statics;
                !e && (e = function () {
            ...
            normalizeCssText: function (a, e) {
                var b = [], c, l = CKEDITOR.tools.parseCssText(a, !0, e);
            ...
            getCookie: function (a) {
                a = a.toLowerCase();
                for (var b = document.cookie.split(";"), c, l,
                         d = 0; d < b.length; d++)if (c = b[d].split("\x3d"), l = decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase()), l === a)return decodeURIComponent(1 < c.length ? c[1] : "");
                return null
            },
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, d = function (a, b) {
            ...
            table: 1,
            ul: 1
        }, g = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, k = {}, l = {"#": 1}, m = {
            center: 1,
            dir: 1,
            noframes: 1
        };
    ...
    (function (a) {
        ...
        a.removeCustomData = function (a) {
            var c = this.$["data-cke-expando"], c = c && d[c], f, g;
        ...
        type: CKEDITOR.NODE_DOCUMENT, appendStyleSheet: function (a) {
            ...
            for (var b =
                ...
                if (d)for (var g = -1, k = 0; k < b.childNodes.length; k++) {
                    ...
                    if (!0 !== d || 3 != l.nodeType || !l.previousSibling || 3 != l.previousSibling.nodeType)if (g++, g == f) {
                        b = l;
                        break
                    }
    ...
    CKEDITOR.dom.element.clearMarkers = function (a, d, b) {
        var c = d.getCustomData("list_marker_names"), f = d.getCustomData("list_marker_id"), g;
    ...
    (function () {
        ...
        function c(a) {
            for (var b = 0, c = 0,
                     e = k[a].length; c < e; c++)b += parseInt(this.getComputedStyle(k[a][c]) || 0, 10) || 0;
            return b
        }
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            is: function () {
                ...
                function a(b, c, e) {
                    if (c && c.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (b.isIdentical(c)) {
                            for (var l = e ? b.getLast() : b.getFirst(); d.length;)d.shift().move(b, !e);
                            c.moveChildren(b, !e);
                            c.remove();
                ...
                if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style"); else {
                    ...
                    for (var b = [], d = 0; d < c.length; d++)if (e)for (var r =
                        0; r < e.length; r++)b.push([a, c[d], e[r]].join("-")); else b.push([a, c[d]].join("-"));
                ...
                if (CKEDITOR.env.ie) {
                    ...
                    for (var a, b = this.getElementsByTag("*"), c = 0,
                             e = b.count(); c < e; c++)a = b.getItem(c), a.setAttribute("unselectable", "on")
                }
                ...
                var b = 0, c = 0, e = this.getDocument(), d = e.getBody(), r = "BackCompat" == e.$.compatMode;
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                        8 !== CKEDITOR.env.version : 1)) {
                    var f = this.$.getBoundingClientRect(), g = e.$.documentElement,
                        q = g.clientTop || d.$.clientTop || 0, w = g.clientLeft || d.$.clientLeft || 0, k = !0;
                    CKEDITOR.env.ie && (k = e.getDocumentElement().contains(this), e = e.getBody().contains(this), k = r && e || !r && k);
                    k && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || g.scrollLeft, c = d.$.scrollTop || g.scrollTop) : (c = r ? d.$ : g, b = c.scrollLeft, c = c.scrollTop), b = f.left + b - w, c = f.top + c - q)
                } else for (q = this, w = null; q && "body" != q.getName() &&
                "html" != q.getName();) {
                    b += q.$.offsetLeft - q.$.scrollLeft;
                    c += q.$.offsetTop - q.$.scrollTop;
                    q.equals(this) || (b += q.$.clientLeft || 0, c += q.$.clientTop || 0);
                    for (; w && !w.equals(q);)b -= w.$.scrollLeft, c -= w.$.scrollTop, w = w.getParent();
                    w = q;
                    q = (f = q.$.offsetParent) ? new CKEDITOR.dom.element(f) : null
                }
                a && (f = this.getWindow(), q = a.getWindow(), !f.equals(q) && f.$.frameElement && (a = (new CKEDITOR.dom.element(f.$.frameElement)).getDocumentPosition(a), b += a.x, c += a.y));
                document.documentElement.getBoundingClientRect || !CKEDITOR.env.gecko ||
                r || (b += this.$.clientLeft ? 1 : 0, c += this.$.clientTop ? 1 : 0);
                return {x: b, y: c}
                ...
                !a && (a = this.getWindow());
                r = a.getDocument();
                var k = "BackCompat" == r.$.compatMode;
                a instanceof CKEDITOR.dom.window && (a = k ? r.getBody() : r.getDocumentElement());
                CKEDITOR.env.webkit && (r = this.getEditor(!1)) && (r._.previousScrollTop = null);
                r = a.getWindow();
                d = q(this, r);
                var t = q(a, r), v = this.$.offsetHeight;
                e = this.$.offsetWidth;
                var h = a.$.clientHeight, p = a.$.clientWidth;
                r = d.x - w(this, "left") - t.x || 0;
                f = d.y - w(this, "top") - t.y || 0;
                e = d.x + e + w(this, "right") - (t.x + p) || 0;
                d = d.y + v + w(this, "bottom") - (t.y + h) || 0;
                (0 > f || 0 < d) && g(0, !0 === b ? f : !1 === b ? d : 0 > f ? f : d);
                c && (0 > r || 0 < e) && g(0 > r ? r : e, 0)
            ...
            getFrameDocument: function () {
                ...
                for (var e = 0; e < c.length; e++) {
                    var d = c[e], f = d.nodeName.toLowerCase(), g;
                    if (!(f in b))if ("checked" == f && (g = this.getAttribute(f))) a.setAttribute(f, g); else if (!CKEDITOR.env.ie || this.hasAttribute(f)) g = this.getAttribute(f), null === g && (g = d.nodeValue), a.setAttribute(f, g)
                }
                "" !== this.$.style.cssText &&
    ...
    (function () {
        function a(a, b) {
            ...
            e = c.endContainer;
            var f = c.startOffset, A = c.endOffset, v, h = this.guard, p = this.type,
                n = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var y = e.type == CKEDITOR.NODE_ELEMENT ? e : e.getParent(),
                    z = e.type == CKEDITOR.NODE_ELEMENT ? e.getChild(A) : e.getNext();
                this._.guardLTR = function (a, b) {
                    return (!b || !y.equals(a)) && (!z || !a.equals(z)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            if (a && !this._.guardRTL) {
                ...
                this._.guardRTL = function (a, b) {
                    return (!b || !g.equals(a)) && (!E || !a.equals(E)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            ...
            this.current ? e = this.current[n](!1, p, v) : (a ? e.type == CKEDITOR.NODE_ELEMENT &&
                (e = 0 < A ? e.getChild(A - 1) : !1 === v(e, !0) ? null : e.getPreviousSourceNode(!0, p, v)) : (e = d, e.type == CKEDITOR.NODE_ELEMENT && ((e = e.getChild(f)) || (e = !1 === v(d, !0) ? null : d.getNextSourceNode(!0, p, v)))), e && !1 === v(e) && (e = null));
            for (; e && !this._.end;) {
                this.current = e;
        ...
        var f = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, g = CKEDITOR.dom.walker.whitespaces(),
            k = CKEDITOR.dom.walker.bookmark(), l = CKEDITOR.dom.walker.temp(), m = function (a) {
        ...
        CKEDITOR.dom.walker.empty = function (a) {
            return function (b) {
                for (var c = 0, e = b.getChildCount(); c < e; ++c)if (!u(b.getChild(c)))return !!a;
                return !a
            }
        };
        var e = CKEDITOR.dom.walker.empty(),
            A = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function (a) {
                var b = {}, c;
        ...
        CKEDITOR.dom.walker.editable = function (a) {
            return function (b) {
                b =
                    u(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(A) && e(b)) ? !0 : !1;
                return !!(a ^ b)
            }
        };
    ...
    (function () {
        ...
        function d(a, b, c, d, f) {
            function q(a, b, c, e) {
                ...
                if (e && l)return d;
                h || e ? b.append(a.clone(!0, f), c) : (a.remove(), v && b.append(a));
                return d
            }

            function g() {
                var a, b, c, e = Math.min(N.length, B.length);
                for (a = 0; a < e; a++)if (b = N[a], c = B[a], !b.equals(c))return a;
                return a - 1
            }

            function k() {
                var b = I - 1, c = C && u && !p.equals(n);
                b < F - 1 || b < K - 1 || c ? (c ? a.moveToPosition(n,
            ...
            a.optimizeBookmark();
            var l = 0 === b, v = 1 == b, h = 2 == b;
            b = h || v;
            var p = a.startContainer, n = a.endContainer,
                y = a.startOffset, z = a.endOffset, J, E, C, u, m, O;
            if (h && n.type == CKEDITOR.NODE_TEXT && p.equals(n)) p = a.document.createText(p.substring(y, z)), c.append(p); else {
                n.type == CKEDITOR.NODE_TEXT ? h ? O = !0 : n = n.split(z) : 0 < n.getChildCount() ? z >= n.getChildCount() ? (n = n.getChild(z - 1), E = !0) : n = n.getChild(z) : u = E = !0;
                p.type == CKEDITOR.NODE_TEXT ? h ? m = !0 : p.split(y) : 0 < p.getChildCount() ? 0 === y ? (p = p.getChild(y), J = !0) : p = p.getChild(y - 1) : C = J = !0;
                for (var N = p.getParents(), B = n.getParents(), I = g(), F = N.length - 1, K = B.length - 1, G = c, L,
                         Z, U, fa = -1, Q = I; Q <= F; Q++) {
                    Z =
                        N[Q];
                    U = Z.getNext();
                    for (Q != F || Z.equals(B[Q]) && F < K ? b && (L = G.append(Z.clone(0, f))) : J ? q(Z, G, !1, C) : m && G.append(a.document.createText(Z.substring(y))); U;) {
                        if (U.equals(B[Q])) {
                            fa = Q;
                            break
                        }
                ...
                G = c;
                for (Q = I; Q <= K; Q++)if (c = B[Q], U = c.getPrevious(), c.equals(N[Q])) b && (G = G.getChild(0)); else {
                    Q != K || c.equals(N[Q]) && K < F ? b && (L = G.append(c.clone(0, f))) : E ? q(c, G, !1, u) : O && G.append(a.document.createText(c.substring(0, z)));
                    if (Q > fa)for (; U;)U = q(U, G, !0);
                    G = L
                }
                h || k()
            }
        ...
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                var b, c, d, f, q = this.collapsed;
                b = this.document.createElement("span");
                b.data("cke-bookmark", 1);
                b.setStyle("display", "none");
                b.setHtml("\x26nbsp;");
                a && (d = "cke_bm_" + CKEDITOR.tools.getNextNumber(), b.setAttribute("id", d + (q ? "C" : "S")));
                q || (c = b.clone(), c.setHtml("\x26nbsp;"), a && c.setAttribute("id", d + "E"), f = this.clone(),
                    f.collapse(), f.insertNode(c));
                f = this.clone();
                f.collapse(!0);
                f.insertNode(b);
                ...
                function a(b) {
                    ...
                    if (e.type == CKEDITOR.NODE_ELEMENT && 0 < d) {
                        a:{
                            for (f = e; d--;)if (g = f.getChild(d).getIndex(!0), 0 <= g) {
                                d = g;
                                break a
                            }
                            d = -1
                    ...
                    if (e.type == CKEDITOR.NODE_TEXT) {
                        ...
                        f = g;
                        e.getText() ? d += f : (g = e.getPrevious(c), f ? (d = f, e = g ? g.getNext() : e.getParent().getFirst()) : (e = e.getParent(), d = g ? g.getIndex(!0) + 1 : 0))
                    }
                    b.container = e;
                    b.offset = d
                }
                ...
                c = this.endContainer;
                d = this.endOffset;
                b || f || !c || c.type != CKEDITOR.NODE_TEXT || (d ? (d >= c.getLength() || c.split(d), d = c.getIndex() + 1) :
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        var g = this.getCommonAncestor(), k = this.root, l, v, h, p, n, y = !1, z, J;
                        z = this.startContainer;
                        var E = this.startOffset;
                        z.type == CKEDITOR.NODE_TEXT ? (E && (z = !CKEDITOR.tools.trim(z.substring(0, E)).length && z, y = !!z), z && ((p = z.getPrevious()) || (h = z.getParent()))) : (E && (p = z.getChild(E - 1) || z.getLast()), p || (h = z));
                        for (h = c(h); h || p;) {
                            if (h && !p) {
                                !n && h.equals(g) && (n = !0);
                                if (f ? h.isBlockBoundary() :
                                        !k.contains(h))break;
                                y && "inline" == h.getComputedStyle("display") || (y = !1, n ? l = h : this.setStartBefore(h));
                                p = h.getPrevious()
                            }
                            for (; p;)if (z = !1, p.type == CKEDITOR.NODE_COMMENT) p = p.getPrevious(); else {
                                if (p.type == CKEDITOR.NODE_TEXT) J = p.getText(), d.test(J) && (p = null), z = /[\s\ufeff]$/.test(J); else if ((p.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && p.is("br")) && !p.data("cke-bookmark"))if (y && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                    J = p.getText();
                                    if (d.test(J)) p = null; else for (var E = p.$.getElementsByTagName("*"), C = 0,
                                                                           u; u =
                                                                           E[C++];)if (!CKEDITOR.dtd.$removeEmpty[u.nodeName.toLowerCase()]) {
                                        p = null;
                                        break
                                    }
                                    p && (z = !!J.length)
                                } else p = null;
                                z && (y ? n ? l = h : h && this.setStartBefore(h) : y = !0);
                                if (p) {
                                    z = p.getPrevious();
                                    if (!h && !z) {
                                        h = p;
                        ...
                        h = p = null;
                        n = y = !1;
                        z.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(z.substring(E)).length ? y = !0 : (y = !z.getLength(), E == z.getLength() ? (p = z.getNext()) || (h = z.getParent()) : q(z, E) && (h = z.getParent())) : (p = z.getChild(E)) || (h = z);
                        for (; h ||
                               p;) {
                            if (h && !p) {
                                !n && h.equals(g) && (n = !0);
                                if (f ? h.isBlockBoundary() : !k.contains(h))break;
                                y && "inline" == h.getComputedStyle("display") || (y = !1, n ? v = h : h && this.setEndAfter(h));
                                p = h.getNext()
                            }
                            for (; p;) {
                                z = !1;
                                if (p.type == CKEDITOR.NODE_TEXT) J = p.getText(), q(p, 0) || (p = null), z = /^[\s\ufeff]/.test(J); else if (p.type == CKEDITOR.NODE_ELEMENT) {
                                    if ((0 < p.$.offsetWidth || b && p.is("br")) && !p.data("cke-bookmark"))if (y && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                        J = p.getText();
                                        if (d.test(J)) p = null; else for (E = p.$.getElementsByTagName("*"), C =
                                            0; u = E[C++];)if (!CKEDITOR.dtd.$removeEmpty[u.nodeName.toLowerCase()]) {
                                            p = null;
                                            break
                                        }
                                        p && (z = !!J.length)
                        ...
                        l && v && (g = l.contains(v) ? v : l, this.setStartBefore(g), this.setEndAfter(g));
                        break;
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var m, O,
                            N = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null),
                            B = null, I = function (a) {
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            h = this.clone();
                            h = new CKEDITOR.dom.walker(h);
                            var F = CKEDITOR.dom.walker.whitespaces(), K = CKEDITOR.dom.walker.bookmark();
                        ...
                        h = new CKEDITOR.dom.walker(h);
                        h.guard = a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? f : I;
                        m = B = O = null;
                        h = h.lastForward();
                        m = m || k;
                ...
                if (!this.collapsed) {
                    ...
                    var d = this.clone(), f = this.startContainer, q = this.endContainer, g = this.startOffset,
                        k = this.endOffset, l = 1, v = 1;
                    f && f.type == CKEDITOR.NODE_TEXT && (g ? g >= f.getLength() ? d.setStartAfter(f) : (d.setStartBefore(f), l = 0) : d.setStartBefore(f));
                    q && q.type == CKEDITOR.NODE_TEXT && (k ? k >= q.getLength() ? d.setEndAfter(q) :
                        (d.setEndAfter(q), v = 0) : d.setEndBefore(q));
                    ...
                    l && (f = d[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) && this.setStartAt(f, b ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_START);
                    v && (d.reset(), (d = d[a == CKEDITOR.SHRINK_ELEMENT ? "lastBackward" : "previous"]()) && this.setEndAt(d, b ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_AFTER_END));
                    return !(!l && !v)
                }
                ...
                var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root),
                    d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), f = c.block, q = d.block, g = null;
                if (!c.blockLimit.equals(d.blockLimit))return null;
                "br" != a && (f || (f = this.fixBlock(!0, a), q = (new CKEDITOR.dom.elementPath(this.endContainer, this.root)).block), q || (q = this.fixBlock(!1, a)));
                c = f && this.checkStartOfBlock();
                d = q && this.checkEndOfBlock();
                this.deleteContents();
                f && f.equals(q) &&
                (d ? (g = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(q, CKEDITOR.POSITION_AFTER_END), q = null) : c ? (g = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(f, CKEDITOR.POSITION_BEFORE_START), f = null) : (q = this.splitElement(f, b || !1), f.is("ul", "ol") || f.appendBogus()));
                return {previousBlock: f, nextBlock: q, wasStartOfBlock: c, wasEndOfBlock: d, elementPath: g}
                ...
                return function (b) {
                    for (var c = this.createBookmark(), d = this[b ? "endPath" : "startPath"](), f = d.block ||
                            d.blockLimit,
                             g; f && !f.equals(d.root) && !f.getFirst(a(f));)g = f.getParent(), this[b ? "setEndAt" : "setStartAt"](f, CKEDITOR.POSITION_AFTER_END), f.remove(1), f = g;
                    this.moveToBookmark(c)
                }
            }(), startPath: function () {
                ...
                f.collapse(d);
                f[d ? "setStartAt" : "setEndAt"](a, d ? CKEDITOR.POSITION_AFTER_START :
                ...
                for (var c = 0; a;) {
                    ...
                    if (a.type == CKEDITOR.NODE_ELEMENT)if (a.isEditable()) this.moveToPosition(a, b ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_AFTER_START), c = 1; else if (b && a.is("br") && this.endContainer && this.checkEndOfBlock()) this.moveToPosition(a, CKEDITOR.POSITION_BEFORE_START); else if ("false" == a.getAttribute("contenteditable") && a.is(CKEDITOR.dtd.$block))return this.setStartBefore(a), this.setEndAfter(a),
                        !0;
                    var d = a, f = c, q = void 0;
                    d.type == CKEDITOR.NODE_ELEMENT && d.isEditable(!1) && (q = d[b ? "getLast" : "getFirst"](u));
                    f || q || (q = d[b ? "getPrevious" : "getNext"](u));
                    a = q
                }
                return !!c
            }, moveToClosestEditablePosition: function (a, b) {
                var c, d = 0, f, q, g = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
                a ? (c = new CKEDITOR.dom.range(this.root), c.moveToPosition(a, g[b ? 0 : 1])) : c = this.clone();
                if (a && !a.is(CKEDITOR.dtd.$block)) d = 1; else if (f = c[b ? "getNextEditableNode" : "getPreviousEditableNode"]()) d = 1, (q = f.type == CKEDITOR.NODE_ELEMENT) &&
                f.is(CKEDITOR.dtd.$block) && "false" == f.getAttribute("contenteditable") ? (c.setStartAt(f, CKEDITOR.POSITION_BEFORE_START), c.setEndAt(f, CKEDITOR.POSITION_AFTER_END)) : !CKEDITOR.env.needsBrFiller && q && f.is(CKEDITOR.dom.walker.validEmptyBlockContainers) ? (c.setEnd(f, 0), c.collapse()) : c.moveToPosition(f, g[b ? 1 : 0]);
                ...
                var c = this.getCommonAncestor(), d = this.getBoundaryNodes(), f = [], q, g, k, l;
                if (c && c.find)for (g = c.find(a), q = 0; q < g.count(); q++)if (c = g.getItem(q), b || !c.isReadOnly()) k = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), l = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED,
                k && l && f.push(c);
                return f
            }
        }
    ...
    (function () {
        ...
        function b(a, c, f, g) {
            ...
            a._.nestedEditable = {element: g.element, container: f, remaining: g.remaining, iterator: c};
            return 1
        }
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                if (!this._.started) {
                    ...
                    k = q.startPath();
                    var w = q.endPath(), H = !q.collapsed && c(q, k.block), t = !q.collapsed && c(q, w.block, 1);
                    q.shrink(CKEDITOR.SHRINK_ELEMENT, !0);
                    H && q.setStartAt(k.block, CKEDITOR.POSITION_BEFORE_END);
                    t && q.setEndAt(w.block, CKEDITOR.POSITION_AFTER_START);
                    k = q.endContainer.hasAscendant("pre", !0) || q.startContainer.hasAscendant("pre", !0);
                    ...
                    (w = new CKEDITOR.dom.elementPath(w.endContainer, w.root), this._.lastNode = (w.block || w.blockLimit).getNextSourceNode(!0))), this._.lastNode && q.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = q.document.createText(""), this._.lastNode.insertAfter(k)), q = null);
                    this._.started = 1;
                    k = q
                }
                w = this._.nextNode;
                ...
                for (this._.nextNode = null; w;) {
                    var H = 0, t = w.hasAscendant("pre"), v = w.type != CKEDITOR.NODE_ELEMENT, h = 0;
                    if (v) w.type == CKEDITOR.NODE_TEXT && f.test(w.getText()) && (v = 0); else {
                        var p = w.getName();
                        if (CKEDITOR.dtd.$block[p] && "false" == w.getAttribute("contenteditable")) {
                            d = w;
                            b(this, a, d);
                            break
                        } else if (w.isBlockBoundary(this.forceBrBreak && !t && {br: 1})) {
                            if ("br" == p) v = 1; else if (!k && !w.getChildCount() && "hr" != p) {
                                d = w;
                                r = w.equals(q);
                                break
                            }
                    ...
                    v && k.setEndAt(w, CKEDITOR.POSITION_AFTER_END);
                    w = this._getNextSourceNode(w, h, q);
                    if ((r = !w) || H && k)break
                }
                if (!d) {
                ...
                D && (x = d.getLast()) && x.type == CKEDITOR.NODE_ELEMENT && "br" == x.getName() && (!CKEDITOR.env.needsBrFiller || x.getPrevious(g) || x.getNext(g)) && x.remove();
                this._.nextNode || (this._.nextNode = r || d.equals(q) || !q ? null : this._getNextSourceNode(d, 1, q));
                return d
    ...
    (function () {
        function a(a, b, c, d, f) {
            ...
            for (h in b) {
                p = b[h];
                p = "boolean" == typeof p ? {} : "function" == typeof p ? {match: p} : C(p);
                ...
                for (F in O) {
                    n[F] = k(n[F], e) || null;
                    var q = n, g = N[F], v = k(n[N[F]], e), y = n[F], B = [], z = !0, K = void 0;
                    v ? z = !1 : v = {};
                    for (K in y)"!" == K.charAt(0) && (K = K.slice(1), B.push(K), v[K] = !0, z = !1);
                    for (; K = B.pop();)y[K] =
                        y["!" + K], delete y["!" + K];
                    q[g] = (z ? !1 : v) || null
                }
            ...
            for (d = a.length; c < d; ++c) {
                ...
                for (F in N) {
                    ...
                    v = [];
                    y = void 0;
                    for (y in g)-1 < y.indexOf("*") ? v.push(new RegExp("^" + y.replace(/\*/g, ".*") + "$")) : v.push(y);
                    g = v;
                    g.length && (n[e] = g, q = !1)
                }
                n.nothingRequired = q;
        ...
        function e(a) {
            var b, c, d, h, p = {}, f = 1;
            for (a = Y(a); b = a.match(B);)(c = b[2]) ? (d = A(c, "styles"), h = A(c, "attrs"), c = A(c, "classes")) : d = h = c = null, p["$" + f++] = {
                elements: b[1],
                classes: c,
                styles: d,
                attributes: h
        ...
        function x(a, b, h, f) {
            var n = 0, e;
            f.toHtml && (b.name = b.name.replace(F, "$1"));
            if (f.doCallbacks && a.elementCallbacks) {
                a:{
                    e = a.elementCallbacks;
                    for (var g = 0, v = e.length, y; g < v; ++g)if (y = e[g](b)) {
                        e = y;
                        break a
                    }
                    e = void 0
            ...
            if (f.doTransform && (e = a._.transformations[b.name])) {
                r(b);
                for (g = 0; g < e.length; ++g)p(a, b, e[g]);
                q(b)
            }
            if (f.doFilter) {
                a:{
                    g = b.name;
                    v = a._;
                    a = v.allowedRules.elements[g];
                    e = v.allowedRules.generic;
                    g = v.disallowedRules.elements[g];
                    v = v.disallowedRules.generic;
                    y = f.skipRequired;
                    var k = {
                        valid: !1,
                        validAttributes: {},
                    ...
                    if (a || e) {
                        r(b);
                        if (g)for (B = 0, z = g.length; B < z; ++B)if (!1 === c(g[B], b, k)) {
                            a = null;
                            break a
                        }
                        if (v)for (B = 0, z = v.length; B < z; ++B)c(v[B], b, k);
                        if (a)for (B = 0, z = a.length; B < z; ++B)d(a[B], b, k, y);
                        if (e)for (B = 0, z = e.length; B < z; ++B)d(e[B], b, k, y);
                        a = k
                    } else a = null
                }
                ...
                var E = a.validStyles;
                e = a.validClasses;
                var g = b.attributes, J = b.styles, v = b.classes;
                y = b.classBackup;
                var l = b.styleBackup, G, I, C = [], k = [], m = /^data-cke-/;
                B = !1;
                delete g.style;
                delete g["class"];
                delete b.classBackup;
                delete b.styleBackup;
                if (!a.allAttributes)for (G in g)z[G] || (m.test(G) ? G == (I = G.replace(/^data-cke-saved-/, "")) || z[I] || (delete g[G], B = !0) : (delete g[G], B = !0));
                if (!a.allStyles || a.hadInvalidStyle) {
                    for (G in J)a.allStyles || E[G] ? C.push(G + ":" + J[G]) : B = !0;
                    C.length && (g.style = C.sort().join("; "))
                } else l && (g.style = l);
                if (!a.allClasses ||
                    a.hadInvalidClass) {
                    for (G = 0; G < v.length; ++G)(a.allClasses || e[v[G]]) && k.push(v[G]);
                    k.length && (g["class"] = k.sort().join(" "));
                    y && k.length < y.split(/\s+/).length && (B = !0)
                } else y && (g["class"] = y);
                B && (n = 1);
                if (!f.skipFinalValidation && !w(b))return h.push(b), 1
            }
            f.toHtml && (b.name = b.name.replace(K, "cke:$1"));
            return n
        }
        ...
        function h(a, b, c) {
            var d = a.name;
            if (E.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(t()) : (a.parent && c.push({
                check: "it",
                el: a.parent
            }), a.remove()); else if (E.$block[d] || "tr" == d)if ("br" == b) a.previous && !v(a.previous) && (b = t(), b.insertBefore(a)), a.next && !v(a.next) && (b = t(), b.insertAfter(a)), a.replaceWithChildren(); else {
                var d = a.children, h;
                b:{
                    h = E[b];
                    for (var p = 0, f = d.length,
                             n; p < f; ++p)if (n = d[p], n.type == CKEDITOR.NODE_ELEMENT && !h[n.name]) {
                        h = !1;
                        break b
                    }
                    h = !0
                ...
                if (h) a.name = b, a.attributes =
                    ...
                    h = a.parent;
                    for (var p = h.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == h.name, e, g,
                             f = d.length; 0 < f;)n = d[--f], p && (n.type == CKEDITOR.NODE_TEXT || n.type == CKEDITOR.NODE_ELEMENT && E.$inline[n.name]) ? (e || (e = new CKEDITOR.htmlParser.element(b), e.insertAfter(a), c.push({
                        check: "parent-down",
                        el: e
                    })), e.add(n, 0)) : (e = null, g = E[h.name] || E.span, n.insertAfter(a), h.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || n.type != CKEDITOR.NODE_ELEMENT || g[n.name] || c.push({
                        check: "el-up",
                        el: n
                    }));
                    a.remove()
        ...
        function n(a, b) {
            var c = b.getDefinition(), d = c.attributes, h = c.styles, p, f, n, e;
            if (a.name != c.element)return !1;
            for (p in d)if ("class" == p)for (c = d[p].split(/\s+/), n = a.classes.join("|"); e = c.pop();) {
                if (-1 == n.indexOf(e))return !1
            } else if (a.attributes[p] != d[p])return !1;
            for (f in h)if (a.styles[f] !=
                h[f])return !1;
            return !0
        }
        ...
        var E = CKEDITOR.dtd, C = CKEDITOR.tools.copy, Y = CKEDITOR.tools.trim, P = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var p = this, f = [], n = this.editor && this.editor.config.protectedSource, e, g = !1, F = {
                    doFilter: !c,
                    doTransform: !0,
                    doCallbacks: !0,
                    toHtml: b
                ...
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-"))if (e = x(p, a, f, F), e & 1) g = !0; else if (e & 2)return !1
                        ...
                        a:{
                            ...
                            c = [];
                            var h, v, y;
                            if (n)for (v = 0; v < n.length; ++v)if ((y = d.match(n[v])) && y[0].length == d.length) {
                                c = !0;
                                break a
                            }
                            d = CKEDITOR.htmlParser.fragment.fromHtml(d);
                            1 == d.children.length && (h = d.children[0]).type == CKEDITOR.NODE_ELEMENT && x(p, h, c, F);
                            c = !c.length
                        }
                        c || f.push(a)
                    }
                ...
                for (var y; c = f.pop();)c.type == CKEDITOR.NODE_ELEMENT ? h(c, d, a) : c.remove();
                for (; v = a.pop();)if (c = v.el, c.parent)switch (y = E[c.parent.name] || E.span, v.check) {
                    case "it":
                        E.$removeEmpty[c.name] && !c.children.length ? h(c, d, a) : w(c) || h(c, d, a);
                        break;
                    case "el-up":
                        c.parent.type ==
                        CKEDITOR.NODE_DOCUMENT_FRAGMENT || y[c.name] || h(c, d, a);
                        break;
                    case "parent-down":
                        c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || y[c.name] || h(c.parent, d, a)
                }
                return g
            ...
            addContentForms: function (a) {
                if (!this.disabled && a) {
                    ...
                    if (h) {
                        for (b = 0; b < a.length; ++b)d.push(y(a[b], h));
                ...
                if (!this.disabled && a) {
                    ...
                    for (h = 0; h < a.length; ++h) {
                        b = a[h];
                        var p = void 0, f = void 0, n = void 0, e = void 0, g = void 0, v = void 0;
                        c = [];
                        for (f = 0; f < b.length; ++f)n = b[f], "string" == typeof n ? (n = n.split(/\s*:\s*/), e = n[0], g = null, v = n[1]) : (e = n.check, g = n.left, v = n.right), p || (p = n, p = p.element ? p.element : e ? e.match(/^([a-z0-9]+)/i)[0] :
                            p.left.getDefinition().element), g instanceof CKEDITOR.style && (g = z(g)), c.push({
                            check: e == p ? null : e,
                            left: g,
                            right: "string" == typeof v ? J(v) : v
                        });
                        b = p;
                        d[b] || (d[b] = []);
                        d[b].push(c)
                ...
                if ("string" == typeof a) {
                    ...
                    h = d
                } else d = a.getDefinition(), h = d.styles, n = d.attributes || {}, h && !CKEDITOR.tools.isEmpty(h) ? (h = C(h), n.style = CKEDITOR.tools.writeCssText(h, !0)) : h = {}, h = {
                    name: d.element,
                    attributes: n,
                ...
                var n = CKEDITOR.tools.clone(h), g = [], v;
                if (!1 !== b && (v = this._.transformations[h.name])) {
                    for (d =
                             0; d < v.length; ++d)p(this, h, v[d]);
                    q(h)
                }
                x(this, n, g, {doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c});
                b = 0 < g.length ? !1 : CKEDITOR.tools.objectCompare(h.attributes, n.attributes, !0) ? !0 : !1;
            ...
            sizeToStyle: function (a) {
                ...
                if ("string" == typeof b) a.name = b; else {
                    var c = b.getDefinition(), d = c.styles,
                        h = c.attributes, p, n, f, e;
                    a.name = c.element;
                    for (p in h)if ("class" == p)for (c = a.classes.join("|"), f = h[p].split(/\s+/); e = f.pop();)-1 == c.indexOf(e) && a.classes.push(e); else a.attributes[p] = h[p];
    ...
    CKEDITOR.scriptLoader = function () {
        ...
        return {
            load: function (b, c, f, g) {
                ...
                k && (b = [b]);
                f || (f = CKEDITOR);
                var l = b.length, m = [], u = [], e = function (a) {
                    c && (k ? c.call(f, a) : c.call(f, m, u))
                };
                if (0 === l) e(!0); else {
                    var A = function (a, b) {
                        (b ? m : u).push(a);
                        0 >= --l && (g && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), e(b))
                    }, r = function (b, c) {
                        a[b] = 1;
                        var f = d[b];
                        delete d[b];
                        ...
                        if (a[b]) A(b, !0); else {
                            ...
                            if (!(1 < f.length)) {
                                ...
                                c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? e.$.onreadystatechange = function () {
                                    if ("loaded" == e.$.readyState || "complete" == e.$.readyState) e.$.onreadystatechange = null, r(b, !0)
                                } : (e.$.onload = function () {
                                    setTimeout(function () {
                                        r(b, !0)
                                    }, 0)
    ...
    CKEDITOR.resourceManager.prototype = {
        add: function (a, d) {
            ...
            for (var c = this.loaded, f = this.registered, g = [], k = {}, l = {}, m = 0; m < a.length; m++) {
                var u = a[m];
                if (u)if (c[u] || f[u]) l[u] = this.get(u); else {
        ...
        return function (b, c, f) {
            var g = {}, k = function (b) {
                a.call(this, b, function (a) {
                    ...
                    var b = [], e;
                    for (e in a) {
                        var l = a[e], r = l && l.requires;
                        if (!d[e]) {
                            if (l.icons)for (var x = l.icons.split(","),
                                                 D = x.length; D--;)CKEDITOR.skin.addIcon(x[D], l.path + "icons/" + (CKEDITOR.env.hidpi && l.hidpi ? "hidpi/" : "") + x[D] + ".png");
                            d[e] = 1
                        }
                        if (r)for (r.split && (r = r.split(",")), l = 0; l < r.length; l++)g[r[l]] || b.push(r[l])
                    }
                    if (b.length) k.call(this,
                        b); else {
                        for (e in g)l = g[e], l.onLoad && !l.onLoad._called && (!1 === l.onLoad() && delete g[e], l.onLoad._called = 1);
                        c && c.call(f || window, g)
                    }
                }, this)
            };
    ...
    (function () {
        ...
        function g(a, b, c) {
            if (b) {
                var d, f, h = a.commands;
                for (f in h)d = h[f], (c || d.contextSensitive) && d.refresh(a, b)
            }
        }
        ...
        function A(a) {
            ...
            if (d)var h = new RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"),
                c = c.replace(h, ""), c = c + ("," + d);
            if (f)var p = new RegExp("(?:^|,)(?:" + f.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"),
                c = c.replace(p, "");
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                a.plugins = c;
                for (var e in c) {
                    var g = c[e], v = g.lang, k = null, l = g.requires, m;
                    CKEDITOR.tools.isArray(l) && (l = l.join(","));
                    if (l && (m = l.match(p)))for (; l = m.pop();)CKEDITOR.error("editor-plugin-required",
                        {plugin: l.replace(",", ""), requiredBy: e});
                    v && !a.lang[e] && (v.split && (v = v.split(",")), 0 <= CKEDITOR.tools.indexOf(v, a.langCode) ? k = a.langCode : (k = a.langCode.replace(/-.*/, ""), k = k != a.langCode && 0 <= CKEDITOR.tools.indexOf(v, k) ? k : 0 <= CKEDITOR.tools.indexOf(v, "en") ? "en" : v[0]), g.langEntries && g.langEntries[k] ? (a.lang[e] = g.langEntries[k], k = null) : f.push(CKEDITOR.getUrl(g.path + "lang/" + k + ".js")));
                    h.push(k);
                    d.push(g)
                }
                CKEDITOR.scriptLoader.load(f, function () {
                    for (var c = ["beforeInit", "init", "afterInit"], f = 0; f < c.length; f++)for (var p =
                        0; p < d.length; p++) {
                        var n = d[p];
                        0 === f && h[p] && n.lang && n.langEntries && (a.lang[n.name] = n.langEntries[h[p]]);
                        if (n[c[f]]) n[c[f]](a)
                    }
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            addCommand: function (a, b) {
                ...
                for (var d = new CKEDITOR.dom.documentFragment, f, h, p, n = 0; n < c.length; n++) {
                    var e = c[n], g = e.startContainer;
                    g.getName && "tr" == g.getName() ? (f || (f = g.getAscendant("table").clone(), f.append(g.getAscendant("tbody").clone()), d.append(f), f = f.findOne("tbody")), h && h.equals(g) || (h = g, p = g.clone(), f.append(p)), p.append(e.cloneContents())) : d.append(e.cloneContents())
                }
                ...
                for (var a = this.keystrokeHandler.keystrokes,
                         b = CKEDITOR.tools.isArray(arguments[0]) ? arguments[0] : [[].slice.call(arguments,
                             0)], c, d,
                         f = b.length; f--;)c = b[f], d = 0, CKEDITOR.tools.isArray(c) && (d = c[1], c = c[0]), d ? a[c] = d : delete a[c]
            }, addFeature: function (a) {
        ...
        CKEDITOR.htmlParser.prototype = {
            onTagOpen: function () {
                ...
                for (var c, f, g = 0, k; c = this._.htmlPartsRegex.exec(b);) {
                    f = c.index;
                    if (f > g)if (g = b.substring(g, f), k) k.push(g); else this.onText(g);
                    ...
                    if (k) k.push(c[0]); else if (f = c[3]) {
                        if (f = f.toLowerCase(), !/="/.test(f)) {
                            ...
                            if (u)for (; m = a.exec(u);) {
                                ...
                                m = m[2] || m[3] || m[4] || "";
                                l[e] = !m && d[e] ? e : CKEDITOR.tools.htmlDecodeAttr(m)
                            }
            ...
            function (g, k, l) {
                function m(a) {
                    ...
                    if (0 < w.length)for (var c = 0; c < w.length; c++) {
                        var d = w[c], h = d.name, f = CKEDITOR.dtd[h], e = t.name && CKEDITOR.dtd[t.name];
                        e && !e[h] || a && f && !f[a] && CKEDITOR.dtd[a] ? h == t.name && (A(t, t.parent, 1), c--) : (b || (u(), b = 1), d = d.clone(), d.parent = t, t = d, w.splice(c, 1), c--)
                    }
                }

                function u() {
                    for (; H.length;)A(H.shift(), t)
                }
                ...
                function A(b, c, d) {
                    c = c || t || q;
                    var f = t;
                    void 0 === b.previous && (r(c, b) && (t = c, D.onTagOpen(l, {}), b.returnPoint = c = t), e(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (h = !1), "textarea" == b.name && (v = !1));
                    b.returnPoint ? (t = b.returnPoint, delete b.returnPoint) : t = d ? c : f
                }
                ...
                var D = new CKEDITOR.htmlParser,
                    q = k instanceof CKEDITOR.htmlParser.element ? k : "string" == typeof k ? new CKEDITOR.htmlParser.element(k) : new CKEDITOR.htmlParser.fragment,
                    w = [], H = [], t = q, v = "textarea" == q.name, h = "pre" == q.name;
                D.onTagOpen = function (f, n, e, g) {
                    n = new CKEDITOR.htmlParser.element(f, n);
                    n.isUnknown && e && (n.isEmpty = !0);
                    n.isOptionalClose = g;
                    if (a(n)) w.push(n); else {
                        ...
                        if ("br" == f) H.push(n); else {
                            for (; !(g = (e = t.name) ? CKEDITOR.dtd[e] || (t._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, n.isUnknown || t.isUnknown || g[f]);)if (t.isOptionalClose) D.onTagClose(e); else if (f in b && e in b) e = t.children, (e = e[e.length - 1]) && "li" == e.name || A(e = new CKEDITOR.htmlParser.element("li"), t), !n.returnPoint && (n.returnPoint = t), t = e; else if (f in CKEDITOR.dtd.$listItem && !x(f, e)) D.onTagOpen("li" == f ? "ul" : "dl", {}, 0, 1); else if (e in d && !x(f, e)) !n.returnPoint && (n.returnPoint = t), t = t.parent; else if (e in CKEDITOR.dtd.$inline && w.unshift(t), t.parent) A(t, t.parent, 1); else {
                                n.isOrphan = 1;
                                break
                            }
                            m(f);
                ...
                D.onTagClose = function (a) {
                    ...
                    for (var c = [], d = [],
                             h = t; h != q && h.name != a;)h._.isBlockLike || d.unshift(h), c.push(h), h = h.returnPoint || h.parent;
                    if (h != q) {
                ...
                D.onText = function (a) {
                    if (!(t._.hasInlineStarted && !H.length || h || v) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length))return;
                    var b = t.name,
                        e = b ? CKEDITOR.dtd[b] || (t._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                    if (!v && !e["#"] && b in d) D.onTagOpen(f[b] || ""), D.onText(a); else {
                        u();
                        m();
                        h || v || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
                        a = new CKEDITOR.htmlParser.text(a);
                        if (r(t, a)) this.onTagOpen(l, {}, 0, 1);
                        t.add(a)
                    }
                };
                D.onCDATA =
        ...
        CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            $: function (b) {
                ...
                addRules: function (a, c) {
                    ...
                    for (var d = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$], g,
                             k = 0; 3 > k; k++)if (g = d[k]) {
                        g = g.exec(a, c, this);
                        if (!1 === g)return null;
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    g = Array.prototype.slice.call(arguments, 1), k = this.rules, l = k.length, m, u, e, A;
                for (A = 0; A < l; A++)if (d && (m = c.type, u = c.name), e = k[A], !(a.nonEditable && !e.options.applyToAll ||
                    a.nestedEditable && e.options.excludeNestedEditable)) {
                    e = e.value.apply(null, g);
                    if (!1 === e || d && e && (e.name != u || e.type != m))return e;
                    null != e && (g[0] = c = e)
                }
                return c
            }, execOnName: function (a, c) {
                for (var d = 0, g = this.rules, k = g.length,
                         l; c && d < k; d++)l = g[d], a.nonEditable && !l.options.applyToAll || a.nestedEditable && l.options.excludeNestedEditable || (c = c.replace(l.value[0], l.value[1]));
                return c
            }
        }
    })();
    (function () {
        function a(a, d) {
            ...
            function n(a, d) {
                return function (h) {
                    if (h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var f = [], n = b(h), v, F;
                        if (n)for (p(n, 1) && f.push(n); n;)g(n) && (v = c(n)) && p(v) && ((F = c(v)) && !g(F) ? f.push(v) : (e(y).insertAfter(v), v.remove())), n = n.previous;
                        for (n = 0; n < f.length; n++)f[n].remove();
                        if (f = !a || !1 !== ("function" == typeof d ? d(h) : d)) y || CKEDITOR.env.needsBrFiller ||
                        h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? y || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || h.name in CKEDITOR.dtd.tr || h.name in CKEDITOR.dtd.$listItem) ? (f = b(h), f = !f || "form" == h.name && "input" == f.name) : f = !1 : f = !1;
                        f && h.add(e(a))
                    }
                }
            }
            ...
            var v = {elements: {}}, y = "html" == d, B = CKEDITOR.tools.extend({}, h), z;
            for (z in B)"#" in t[z] || delete B[z];
            for (z in B)v.elements[z] = n(y, a.config.fillEmptyBlocks);
            v.root = n(y, !1);
            v.elements.br = function (a) {
                return function (b) {
                    if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if ("data-cke-bogus" in d || "data-cke-eol" in d) delete d["data-cke-bogus"]; else {
                            for (d = b.next; d && f(d);)d =
                                d.next;
                            var h = c(b);
                            !d && g(b.parent) ? k(b.parent, e(a)) : g(d) && h && !g(h) && e(a).insertBefore(d)
                        }
                    }
                }
            }(y);
        ...
        function q(a, b) {
            ...
            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function (a, c, d, h) {
                return "\x3c" + c + d + "\x3e" + D(x(h), b) + "\x3c/" + c + "\x3e"
            })
        }
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, h, c = q(c, b), c = e(c, P), c = u(c), c = e(c, Y), c = c.replace(N, "$1cke:$2"),
                ...
                var f;
                CKEDITOR.env.ie && 9 > CKEDITOR.env.version && "pre" == h && (h = "div", c = "\x3cpre\x3e" + c + "\x3c/pre\x3e", f = 1);
                ...
                h && (f = c, !f.children.length && CKEDITOR.dtd[f.name][h] && (h = new CKEDITOR.htmlParser.element(h), f.add(h)));
                a.dataValue = c
            }, null, null, 5);
            b.on("toHtml", function (a) {
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function (a, b, c, d) {
                var h = this.editor, f, e, n, p;
                b && "object" == typeof b ? (f = b.context, c = b.fixForBody, d = b.dontFilter, e = b.filter, n = b.enterMode, p = b.protectedWhitespaces) : f = b;
        ...
        var w = /(?:&nbsp;|\xa0)$/, H = "{cke_protected}", t = CKEDITOR.dtd,
            v = "caption colgroup col thead tfoot tbody".split(" "), h = CKEDITOR.tools.extend({}, t.$blockLimit,
            t.$block), p = {
                elements: {
                    input: l,
                    textarea: l
                ...
                elementNames: [[/^cke:/, ""], [/^\?xml:namespace$/, ""]], attributeNames: [[/^data-cke-(saved|pa)-/,
                    ...
                    $: function (a) {
                        ...
                        if (b) {
                            ...
                            for (var c = ["name", "href", "src"], d,
                                     h = 0; h < c.length; h++)d = "data-cke-saved-" + c[h], d in b && delete b[c[h]]
                        }
                        return a
                    }, table: function (a) {
                        a.children.slice(0).sort(function (a, b) {
                            var c, d;
                            a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type && (c = CKEDITOR.tools.indexOf(v, a.name), d = CKEDITOR.tools.indexOf(v, b.name));
        ...
        var J = /<(a|area|img|input|source)\b([^>]*)>/gi,
            E = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, C = /^(href|src|name)$/i,
            Y = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
            P = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, O = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
                ...
                var m, u;
                for (m in k) {
                    for (l = k[m]; ;)if (u = a.onAttributeName(b, m))if (u != m) delete k[m], m = u; else break; else {
                        delete k[m];
                        break
                    }
                    u && (!1 === (l = a.onAttribute(b, d, u, l)) ? delete k[u] :
                        k[u] = l)
                }
                ...
                b && this.filter(b);
                var g = this.name, k = [], l = this.attributes, m, u;
                a.openTag(g, l);
                for (m in l)k.push([m, l[m]]);
                a.sortAttributes && k.sort(d);
                m = 0;
                for (u = k.length; m < u; m++)l = k[m], a.attribute(l[0], l[1]);
                ...
                for (var b = this.children.splice(a, this.children.length - a), d = this.clone(),
                         k = 0; k < b.length; ++k)b[k].parent = d;
                d.children = b;
    ...
    (function () {
        ...
        CKEDITOR.template = function (g) {
            if (a[g]) this.output = a[g]; else {
                var k = g.replace(b, "\\$1").replace(c, "\\n").replace(f, "\\r").replace(d, function (a, b) {
    ...
    (function () {
        ...
        CKEDITOR.inlineAll = function () {
            var a, d, b;
            for (b in CKEDITOR.dtd.$editable)for (var c = CKEDITOR.document.getElementsByTag(b), f = 0,
                                                      g = c.count(); f < g; f++)a = c.getItem(f), "true" == a.getAttribute("contenteditable") && (d = {
                element: a,
                config: {}
    ...
    (function () {
        function a(a, f, g, k) {
            ...
            a = CKEDITOR.dom.element.get(a);
            if (a.getEditor())throw'The editor instance "' + a.getEditor().name + '" is already attached to the provided element.';
            var l = new CKEDITOR.editor(f, a, k);
        ...
        CKEDITOR.editor.prototype.setMode = function (a, b) {
            ...
            if (a != d.mode && k && k[a]) {
                ...
                if (d.mode) {
                    var l = d.checkDirty(), k = d._.previousModeData, m, u = 0;
                    d.fire("beforeModeUnload");
                    d.editable(0);
                    d._.previousMode = d.mode;
                    d._.previousModeData = m = d.getData(1);
                    "source" == d.mode && k == m && (d.fire("lockSnapshot", {forceUpdate: !0}), u = 1);
    ...
    (function () {
        function a(a) {
            ...
            k(b, e.block, n) && g.collapsed && !g.getCommonAncestor().isReadOnly() && (e = g.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), n = new CKEDITOR.dom.walker(e), n.guard = function (a) {
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                focus: function () {
                    ...
                    var g, k;
                    if (f)for (; (g = b.getCommonAncestor(0, 1)) && (k = CKEDITOR.dtd[g.getName()]) && (!k || !k[e]);)g.getName() in CKEDITOR.dtd.span ? b.splitElement(g) : b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(g), b.collapse(!0), g.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
                    b.insertNode(a);
                    return !0
                ...
                fixInitialSelection: function () {
                    ...
                    } else c.autoParagraph(this.editor, a), r(a.startContainer) && a.startContainer.appendBogus();
                    ...
                    if (!this.is("textarea")) {
                        ...
                        if (k) {
                            var n = f.getHead(), z = n.getCustomData("stylesheet");
                            z ? k != z.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? z.$.styleSheet.cssText = k : z.setText(k)) : (k = f.appendStyleText(k), k = new CKEDITOR.dom.element(k.ownerNode || k.owningElement), n.setCustomData("stylesheet", k), k.data("cke-temp", 1))
                        }
                        n = f.getCustomData("stylesheet_ref") || 0;
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in l) {
                                b = a.getSelection();
                                var h, f = b.getRanges()[0], n = f.startPath(), p, k, y, c = 8 == c;
                                CKEDITOR.env.ie && 11 > CKEDITOR.env.version && (h =
                        ...
                        CKEDITOR.env.webkit && this.attachListener(a, "key", function (b) {
                            ...
                            if (b in l) {
                                ...
                                if (d.collapsed)a:{
                                    var h = b.block;
                                    if (h && d[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && d.moveToClosestEditablePosition(h,
                                            !c) && d.collapsed) {
                                    ...
                                    e = b.block, d = c.endPath().block, e && d && !e.equals(d) ? (a.fire("saveSnapshot"), (h = e.getBogus()) && h.remove(), c.enlarge(CKEDITOR.ENLARGE_INLINE), c.deleteContents(), d.getParent() && (d.moveChildren(e, !1), b.lastElement.mergeSiblings(), u(e, d, !0)), c = a.getSelection().getRanges()[0], c.collapse(1), c.optimize(), "" === c.startContainer.getHtml() && c.startContainer.appendBogus(), c.select(), b = !0) : b = !1;
                                if (!b)return;
                ...
                if (a && a.isInline()) {
                    ...
                    if (d && (c = this.ui.space(this.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? "top" :
                        ...
                        var f = CKEDITOR.tools.getNextId(),
                            d = CKEDITOR.dom.element.createFromHtml('\x3cspan id\x3d"' + f + '" class\x3d"cke_voice_label"\x3e' + d + "\x3c/span\x3e");
                        c.append(d);
        ...
        q = function () {
            ...
            function b(c, d) {
                var f, e, n, p, g = [], k = d.range.startContainer;
                f = d.range.startPath();
                for (var k = E[k.getName()], y = 0, l = c.getChildren(), z = l.count(), J = -1, m = -1, q = 0,
                         u = f.contains(E.$list); y < z; ++y)f = l.getItem(y), a(f) ? (n = f.getName(), u && n in CKEDITOR.dtd.$list ? g = g.concat(b(f, d)) : (p = !!k[n], "br" != n || !f.data("cke-eol") || y && y != z - 1 || (q = (e = y ? g[y - 1].node : l.getItem(y + 1)) && (!a(e) || !e.is("br")), e = e && a(e) && E.$block[e.getName()]), -1 != J || p || (J = y), p || (m = y), g.push({
                    isElement: 1,
                    isLineBreak: q, isBlock: f.isBlockBoundary(), hasBlockSibling: e, node: f, name: n, allowed: p
                }), e = q = 0)) : g.push({isElement: 0, node: f, allowed: 1});
                -1 < J && (g[J].firstNotAllowed = 1);
                -1 < m && (g[m].lastNotAllowed = 1);
                return g
            }

            function d(b, c) {
                var f = [], e = b.getChildren(), h = e.count(), n, g = 0, k = E[c], y = !b.is(E.$inline) || b.is("br");
                for (y && f.push(" "); g < h; g++)n = e.getItem(g), a(n) && !n.is(k) ? f = f.concat(d(n, c)) : f.push(n);
                y && f.push(" ");
                return f
            }
            ...
            function g(b, c, d, f) {
                ...
                (h = (new CKEDITOR.dom.walker(e)).next()) && a(h) && m[h.getName()] && (n = h.getPrevious()) && a(n) && !n.getParent().equals(b.startContainer) && d.contains(n) && f.contains(h) && h.isIdentical(n) && (h.moveChildren(n), h.remove(), g(b, c, d, f))
            }
            ...
            function J(b, c) {
                ...
                f && d(f, b[b.length - 1]);
                e && d(e, b[0]) && (c.setEnd(c.endContainer, c.endOffset - 1), c.collapse())
            }

            var E = CKEDITOR.dtd, m = {
                p: 1,
                div: 1,
                h1: 1,
                h2: 1,
                ...
                dl: 1,
                blockquote: 1
            }, q = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, u = CKEDITOR.tools.extend({}, E.$inline);
            delete u.br;
            return function (m, C, B, I) {
                ...
                if (!I.checkReadOnly()) {
                    ...
                    m.endPath = G = new CKEDITOR.dom.elementPath(C.endContainer);
                    if (!C.collapsed) {
                        var F = G.block || G.blockLimit, w = C.getCommonAncestor();
                        F && !F.equals(w) && !F.contains(w) && C.checkEndOfBlock() && m.zombies.push(F);
                        C.deleteContents()
                    }
                    for (; (r = f(C)) && a(r) && r.isBlockBoundary() && K.contains(r);)C.moveToPosition(r, CKEDITOR.POSITION_BEFORE_END);
                    g(C, m.blockLimit, K, G);
                    L && (C.setEndBefore(L), C.collapse(), L.remove());
                    L = C.startPath();
                    if (F = L.contains(e, !1, 1)) C.splitElement(F), m.inlineStylesRoot = F, m.inlineStylesPeak = L.lastElement;
                    L = C.createBookmark();
                    (F = L.startNode.getPrevious(c)) && a(F) && e(F) && I.push(F);
                    (F = L.startNode.getNext(c)) && a(F) && e(F) && I.push(F);
                    for (F = L.startNode; (F =
                        F.getParent()) && e(F);)I.push(F);
                    C.moveToBookmark(L);
                    if (L = B) {
                        L = m.range;
                        if ("text" == m.type && m.inlineStylesRoot) {
                            r = m.inlineStylesPeak;
                            C = r.getDocument().createText("{cke-peak}");
                            for (I = m.inlineStylesRoot.getParent(); !r.equals(I);)C = C.appendTo(r.clone()), r = r.getParent();
                            B = C.getOuterHtml().split("{cke-peak}").join(B)
                        }
                        r = m.blockLimit.getName();
                        if (/^\s+|\s+$/.test(B) && "span" in CKEDITOR.dtd[r]) {
                        ...
                        if ((A = L.startPath().block) && (1 != A.getChildCount() || !A.getBogus()))a:{
                            var x;
                            if (1 == r.getChildCount() && a(x = r.getFirst()) && x.is(q) && !x.hasAttribute("contenteditable")) {
                                A = x.getElementsByTag("*");
                                L = 0;
                                for (I = A.count(); L < I; L++)if (C = A.getItem(L), !C.is(u))break a;
                    ...
                    if (L) {
                        ...
                        var R, W;
                        C = x.startContainer;
                        var K = m.endPath.elements[0], X, G = K.getPosition(C),
                            w = !!K.getCommonAncestor(C) && G != CKEDITOR.POSITION_IDENTICAL && !(G & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
                        C = b(m.dataWrapper, m);
                        for (J(C, x); I < C.length; I++) {
                            G = C[I];
                            if (t = G.isLineBreak) {
                                t = x;
                                R = r;
                                var T = void 0, aa = void 0;
                                G.hasBlockSibling ? t = 1 : (T = t.startContainer.getAscendant(E.$block, 1)) && T.is({
                                    div: 1,
                                    p: 1
                                }) ? (aa =
                            ...
                            if (t) B = 0 < I; else {
                                t = x.startPath();
                                !G.isBlock && k(m.editor, t.block, t.blockLimit) && (H = l(m.editor)) && (H = L.createElement(H), H.appendBogus(), x.insertNode(H), CKEDITOR.env.needsBrFiller && (D = H.getBogus()) && D.remove(), x.moveToPosition(H, CKEDITOR.POSITION_BEFORE_END));
                                if ((t = x.startPath().block) && !t.equals(M)) {
                                    if (D = t.getBogus()) D.remove(), A.push(t);
                                    M = t
                                }
                                G.firstNotAllowed && (F = 1);
                                if (F && G.isElement) {
                                    t = x.startContainer;
                                    for (R = null; t && !E[t.getName()][G.name];) {
                                        if (t.equals(r)) {
                                            t = null;
                                            break
                                        }
                                    ...
                                    if (t) R && (W = x.splitElement(R), m.zombies.push(W), m.zombies.push(R)); else {
                                        R = r.getName();
                                        X = !I;
                                        t = I == C.length - 1;
                                        R = d(G.node, R);
                                        for (var T = [], aa = R.length, ba = 0, da = void 0, ea = 0,
                                                 ga = -1; ba < aa; ba++)da = R[ba], " " == da ? (ea || X && !ba || (T.push(new CKEDITOR.dom.text(" ")), ga = T.length), ea = 1) : (T.push(da), ea = 0);
                                        t && ga == T.length && T.pop();
                                        X = T
                                    }
                                }
                                ...
                                G.lastNotAllowed && I < C.length - 1 && ((W = w ? K : W) && x.setEndAt(W, CKEDITOR.POSITION_AFTER_START), F = 0);
                                x.collapse()
                            }
                        }
                        1 != C.length ? D = !1 : (D = C[0], D = D.isElement && "false" == D.node.getAttribute("contenteditable"));
                        D && (B = !0, t = C[0].node, x.setStartAt(t, CKEDITOR.POSITION_BEFORE_START), x.setEndAt(t, CKEDITOR.POSITION_AFTER_END));
                        m.dontMoveCaret = B;
                        m.bogusNeededBlocks = A
                    }
                    D = m.range;
                    var S;
                    W = m.bogusNeededBlocks;
                    for (X = D.createBookmark(); M = m.zombies.pop();)M.getParent() && (H = D.clone(), H.moveToElementEditStart(M),
        ...
        w = function () {
            ...
            return function (d) {
                var f =
                    d.startContainer, e = f.getAscendant("table", 1), g = !1;
                c(e.getElementsByTag("td"));
                c(e.getElementsByTag("th"));
                e = d.clone();
                e.setStart(f, 0);
                e = a(e).lastBackward();
                e || (e = d.clone(), e.setEndAt(f, CKEDITOR.POSITION_BEFORE_END), e = a(e).lastForward(), g = !0);
                e || (e = f);
                e.is("table") ? (d.setStartAt(e, CKEDITOR.POSITION_BEFORE_START), d.collapse(!0), e.remove()) : (e.is({
                    tbody: 1,
                    thead: 1,
                    tfoot: 1
                }) && (e = b(e, "tr", g)), e.is("tr") && (e = b(e, e.getParent().is("thead") ? "th" : "td", g)), (f = e.getBogus()) && f.remove(), d.moveToPosition(e, g ? CKEDITOR.POSITION_AFTER_START :
                    CKEDITOR.POSITION_BEFORE_END))
            }
        }();
        H = {
                ...
                list: {
                    ...
                    function a(c) {
                        ...
                        h.guard = function (a, h) {
                            ...
                            if (h && g && a.equals(g)) f = c.clone(), f.setEndAt(g, CKEDITOR.POSITION_BEFORE_END), e.push(f); else if (!h && n && a.equals(n)) f = c.clone(), f.setStartAt(n, CKEDITOR.POSITION_AFTER_START),
                                e.push(f); else {
                                if (k = !h) k = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!g || b(a, g)) && (!n || b(a, n));
                    ...
                    return {
                        detectPurge: function (a) {
                            ...
                            var h = c(f, e.bookmark), g = h.clone(), k, l, m = h.getCommonAncestor();
                            m.is(CKEDITOR.dtd.$tableContent) && !m.is(d) && (m = m.getAscendant("table",
                                !0));
                            l = m;
                            m = new CKEDITOR.dom.elementPath(h.startContainer, l);
                            l = new CKEDITOR.dom.elementPath(h.endContainer, l);
                            m = m.contains("table");
                            l = l.contains("table");
                            if (m || l) m && l && b(m, l) ? (e.tableSurroundingRange = g, g.setStartAt(m, CKEDITOR.POSITION_AFTER_END), g.setEndAt(l, CKEDITOR.POSITION_BEFORE_START), g = h.clone(), g.setEndAt(m, CKEDITOR.POSITION_AFTER_END), k = h.clone(), k.setStartAt(l, CKEDITOR.POSITION_BEFORE_START), k = a(g).concat(a(k))) : m ? l || (e.tableSurroundingRange = g, g.setStartAt(m, CKEDITOR.POSITION_AFTER_END), h.setEndAt(m,
                            ...
                            for (var b; b = a.tableContentsRanges.pop();)b.extractContents(), r(b.startContainer) && b.startContainer.appendBogus();
    ...
    (function () {
        ...
        function l(a, b) {
            return b ? a.replace(D, function (a, b) {
                return b ? " " : ""
            }) : a.replace(x, "")
        }
        ...
        var A = "function" != typeof window.getSelection, r = 1, x = CKEDITOR.tools.repeat("​", 7),
            D = new RegExp(x + "( )?", "g"), q, w, H = CKEDITOR.dom.walker.invisible(1), t = function () {
                function a(b) {
                    return function (a) {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            e.on("contentDom", function () {
                ...
                var f = e.document, h = CKEDITOR.document, g = e.editable(), p = f.getBody(),
                    l = f.getDocumentElement(), m = g.isInline(), q, B;
                CKEDITOR.env.gecko && g.attachListener(g, "focus",
                    function (a) {
                        a.removeListener();
                        0 !== q && (a = e.getSelection().getNative()) && a.isCollapsed && a.anchorNode == g.$ && (a = e.createRange(), a.moveToElementEditStart(g), a.select())
                    }, null, null, -2);
                g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function () {
                    q && CKEDITOR.env.webkit && (q = e._.previousActive && e._.previousActive.equals(f.getActive())) && null != e._.previousScrollTop && e._.previousScrollTop != g.$.scrollTop && (g.$.scrollTop = e._.previousScrollTop);
                    e.unlockSelection(q);
                    q = 0
                }, null, null, -1);
                g.attachListener(g,
                ...
                if (CKEDITOR.env.ie || m) A ? g.attachListener(g, "beforedeactivate", b, null, null, -1) : g.attachListener(e, "selectionCheck", b, null, null, -1), g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function () {
                    e.lockSelection(B);
                    q = 1
                            ...
                            l.on("mousedown", function (a) {
                                function b(a) {
                                    ...
                                    if (F) {
                                        ...
                                        F.setEndPoint(0 > K.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c);
                                        F.select()
                                    }
                                }
                                ...
                                if (a.getTarget().is("html") && a.$.y < l.$.clientHeight && a.$.x < l.$.clientWidth) {
                                    F = p.$.createTextRange();
                                    try {
                                        F.moveToPoint(a.$.clientX, a.$.clientY)
                                    } catch (d) {
                                    }
                                    K = F.duplicate();
                                    l.on("mousemove", b);
                ...
                CKEDITOR.env.webkit && g.attachListener(f, "keydown", function (a) {
                    ...
                    null, null, -1);
                g.attachListener(g, "keydown", u(e), null, null, -1)
            });
        ...
        CKEDITOR.dom.selection.prototype = {
            getNative: function () {
                return void 0 !== this._.cache.nativeSel ? this._.cache.nativeSel : this._.cache.nativeSel = A ? this.document.$.selection : this.document.getWindow().$.getSelection()
            }, getType: A ? function () {
                var a = this._.cache;
                ...
                if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE; else if (1 == c.rangeCount) {
                    ...
                    d == c.endContainer && 1 == d.nodeType && 1 == c.endOffset - c.startOffset && v[d.childNodes[c.startOffset].nodeName.toLowerCase()] && (b = CKEDITOR.SELECTION_ELEMENT)
                }
                return a.type = b
            }, getRanges: function () {
                var a = A ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var e = d.children, f, h, g = b.duplicate(), k = 0, l = e.length - 1, B = -1, n,
                                 m; k <= l;)if (B = Math.floor((k + l) / 2), f = e[B], g.moveToElementText(f), n = g.compareEndPoints("StartToStart", b), 0 < n) l = B - 1; else if (0 > n) k = B + 1; else return {
                            container: d,
                            offset: a(f)
                        };
                        if (-1 == B || B == e.length - 1 && 0 > n) {
                            ...
                            for (d = e.length; 0 < g && 0 < d;)h = e[--d], h.nodeType == CKEDITOR.NODE_TEXT && (m = h, g -= h.nodeValue.length);
                    ...
                    return function () {
                        ...
                        if (d == CKEDITOR.SELECTION_ELEMENT) {
                            for (var d = [], e = 0; e < c.length; e++) {
                                for (var f = c.item(e), g = f.parentNode, h = 0,
                                         a = new CKEDITOR.dom.range(this.root); h < g.childNodes.length && g.childNodes[h] != f; h++);
                ...
                var b = this, c = CKEDITOR.tools.tryThese(function () {
                    ...
                    for (var a = b.getRanges()[0].clone(), c, d,
                             e = 2; e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && v[c.getName()] && (d = c)); e--)a.shrink(CKEDITOR.SHRINK_ELEMENT);
                    return d && d.$
                });
                ...
                var b = this.getNative(), b = A ? "Control" == b.type ? "" : b.createRange().text : b.toString();
                ...
                this.reset();
                if (b)for (var b = this.root, c,
                               d = 0; d < a.length; ++d)c = a[d], c.endContainer.equals(b) && (c.endOffset = Math.min(c.endOffset, b.getChildCount()));
                if (a.length)if (this.isLocked) {
                    ...
                    a:{
                        var m, q;
                        if (1 == a.length && !(q = a[0]).collapsed && (l = q.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT && (q = q.clone(), q.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (m = q.getEnclosedNode()) && m.type == CKEDITOR.NODE_ELEMENT && (l = m), "false" == l.getAttribute("contenteditable")))break a;
                        l = void 0
                    }
                    if (l) this.fake(l); else {
                        if (A) {
                            ...
                            if ((c = l.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT &&
                                c.getName() in v && (!c.is("a") || !c.getText()))try {
                            ...
                            e ? (m = l.document.$.body.createTextRange(),
                                m.moveToElementText(e.$), t.setEndPoint("EndToEnd", m), t.moveEnd("character", -1)) : (u = b.getNext(q), r = b.hasAscendant("pre"), u = !(u && u.getText && u.getText().match(m)) && (r || !b.hasPrevious() || b.getPrevious().is && b.getPrevious().is("br")), r = l.document.createElement("span"), r.setHtml("\x26#65279;"), r.insertBefore(b), u && l.document.createText("﻿").insertBefore(b));
                            l.setStartBefore(b);
                            b.remove();
                            a ? (u ? (t.moveStart("character", -1), t.select(), l.document.$.selection.clear()) : t.select(), l.moveToPosition(r, CKEDITOR.POSITION_BEFORE_START),
                            ...
                            for (t = 0; t < a.length; t++) {
                                if (t < a.length - 1 && (u = a[t], r = a[t + 1], m = u.clone(), m.setStart(u.endContainer, u.endOffset), m.setEnd(r.startContainer, r.startOffset), !m.collapsed && (m.shrink(CKEDITOR.NODE_ELEMENT, !0), l = m.getCommonAncestor(), m = m.getEnclosedNode(), l.isReadOnly() || m && m.isReadOnly()))) {
                                ...
                                l.collapsed && CKEDITOR.env.webkit && f(l) && (m = g(this.root), l.insertNode(m), (u = m.getNext()) && !m.getPrevious() && u.type == CKEDITOR.NODE_ELEMENT && "br" == u.getName() ? (k(this.root), l.moveToPosition(u, CKEDITOR.POSITION_BEFORE_START)) : l.moveToPosition(m, CKEDITOR.POSITION_AFTER_END));
                                r.setStart(l.startContainer.$, l.startOffset);
                                try {
                                    r.setEnd(l.endContainer.$, l.endOffset)
                                } catch (B) {
                                    if (0 <= B.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) l.collapse(1), r.setEnd(l.endContainer.$, l.endOffset); else throw B;
                                }
                                e.addRange(r)
                            }
                        }
    ...
    (function () {
        function a(a, b) {
            for (var c,
                     d; (a = a.getParent()) && !a.equals(b);)if (a.getAttribute("data-nostyle")) c = a; else if (!d) {
        ...
        function b(c) {
            var e = c.document;
            if (c.collapsed) e = H(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END); else {
                ...
                c.trim();
                var p = c.createBookmark(), q = p.startNode, u = p.endNode, r = q, t;
                if (!l) {
                    var v = c.getCommonAncestor(), l = a(q, v), v = a(u, v);
                    l && (r = l.getNextSourceNode(!0));
                    v && (u = v)
                }
                for (r.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    l = !1;
                    if (r.equals(u)) r = null, l = !0; else {
                        var x = r.type == CKEDITOR.NODE_ELEMENT ? r.getName() : null,
                            v = x && "false" == r.getAttribute("contentEditable"), A = x &&
                                r.getAttribute("data-nostyle");
                        if (x && r.data("cke-bookmark")) {
                            r = r.getNextSourceNode(!0);
                            continue
                        }
                        if (v && m && CKEDITOR.dtd.$block[x])for (var w = r, y = f(w), z = void 0, C = y.length, E = 0,
                                                                      w = C && new CKEDITOR.dom.range(w.getDocument()); E < C; ++E) {
                            var z = y[E], J = CKEDITOR.filter.instances[z.data("cke-filter")];
                            if (J ? J.check(this) : 1) w.selectNodeContents(z), b.call(this, w)
                        }
                        y = x ? !n[x] || A ? 0 : v && !m ? 0 : d(r, u, h, O) : 1;
                        if (y)if (z = r.getParent(), y = h, C = g, E = k, !z || !(z.getDtd() || CKEDITOR.dtd.span)[C] && !E || y.parentRule && !y.parentRule(z)) l = !0; else {
                            if (t ||
                                x && CKEDITOR.dtd.$removeEmpty[x] && (r.getPosition(u) | O) != O || (t = c.clone(), t.setStartBefore(r)), x = r.type, x == CKEDITOR.NODE_TEXT || v || x == CKEDITOR.NODE_ELEMENT && !r.getChildCount()) {
                                for (var x = r,
                                         P; (l = !x.getNext(Y)) && (P = x.getParent(), n[P.getName()]) && d(P, q, h, N);)x = P;
                                t.setEndAfter(x)
                            }
                        } else l = !0;
                        r = r.getNextSourceNode(A || v)
                    }
                    if (l && t && !t.collapsed) {
                        for (var l = H(this, e), v = l.hasAttributes(), A = t.getCommonAncestor(), x = {}, y = {},
                                 z = {}, C = {}, S, V, ca; l && A;) {
                            if (A.getName() == g) {
                                for (S in h.attributes)!C[S] && (ca = A.getAttribute(V)) &&
                                (l.getAttribute(S) == ca ? y[S] = 1 : C[S] = 1);
                                for (V in h.styles)!z[V] && (ca = A.getStyle(V)) && (l.getStyle(V) == ca ? x[V] = 1 : z[V] = 1)
                            }
                            A = A.getParent()
                        }
                        for (S in y)l.removeAttribute(S);
                        for (V in x)l.removeStyle(V);
        ...
        function c(a) {
            function b() {
                for (var a = new CKEDITOR.dom.elementPath(d.getParent()),
                         c = new CKEDITOR.dom.elementPath(m.getParent()), e = null, f = null,
            ...
            if (a.collapsed) {
                for (var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root), f, g = 0,
                         k; g < e.elements.length && (k = e.elements[g]) && k != e.block && k != e.blockLimit; g++)if (this.checkElementRemovable(k)) {
                    var l;
                    a.collapsed && (a.checkBoundaryOfElement(k, CKEDITOR.END) || (l = a.checkBoundaryOfElement(k, CKEDITOR.START))) ? (f = k, f.match = l ? "start" : "end") : (k.mergeSiblings(), k.is(this.element) ? x.call(this, k) : q(k, h(this)[k.getName()]))
                }
                if (f) {
                    k = d;
                    for (g = 0; ; g++) {
                ...
                b();
                for (e = d; !e.equals(m);)f = e.getNextSourceNode(), e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e) && (e.getName() == this.element ? x.call(this, e) : q(e, h(this)[e.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) && (b(), f = d.getNext())), e = f
            }
            a.moveToBookmark(c);
        ...
        function l(a) {
            ...
            for (var d, e = a.document,
                     f; d = c.getNextParagraph();)!d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = H(this, e, d), u(d, f));
            a.moveToBookmark(b)
        }
        ...
        function m(a) {
            ...
            (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), u(d, e)) : x.call(this, d));
            a.moveToBookmark(b)
        }
        ...
        function u(a, b) {
            ...
            if (d && !f) {
                ...
                b = f
            } else g ? b = r(c ? [a.getHtml()] : e(a), b) : a.moveChildren(b);
            b.replace(a);
            if (d) {
                var c = b, k;
                (k = c.getPrevious(P)) && k.type == CKEDITOR.NODE_ELEMENT && k.is("pre") && (d = A(k.getHtml(), /\n$/, "") + "\n\n" + A(c.getHtml(), /^\n/, ""), CKEDITOR.env.ie ? c.$.outerHTML = "\x3cpre\x3e" + d + "\x3c/pre\x3e" :
        ...
        function D(a) {
            for (var b = h(this), c = a.getElementsByTag(this.element), d,
                     e = c.count(); 0 <= --e;)d = c.getItem(e), d.isReadOnly() || x.call(this, d, !0);
        ...
        var z = {
            ...
            audio: 1,
            video: 1
        }, E = /\s*(?:;\s*|$)/, C = /#\((.+?)\)/g, Y = CKEDITOR.dom.walker.bookmark(0,
        ...
        CKEDITOR.style = function (a, b) {
            ...
            b && (a = CKEDITOR.tools.clone(a), v(a.attributes, b), v(a.styles, b));
            c = this.element = a.element ? "string" == typeof a.element ? a.element.toLowerCase() : a.element : "*";
            this.type = a.type || (z[c] ? CKEDITOR.STYLE_BLOCK : J[c] ? CKEDITOR.STYLE_OBJECT :
        ...
        CKEDITOR.style.prototype = {
            apply: function (a) {
                ...
                this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? c : this.type == CKEDITOR.STYLE_BLOCK ? m : this.type == CKEDITOR.STYLE_OBJECT ? k : null;
                ...
                switch (this.type) {
                    ...
                    case CKEDITOR.STYLE_INLINE:
                        for (var c = a.elements, d = 0,
                                 e; d < c.length; d++)if (e = c[d], this.type != CKEDITOR.STYLE_INLINE || e != a.block && e != a.blockLimit) {
    ...
    (function () {
        ...
        CKEDITOR.dom.elementPath = function (b, f) {
            ...
            do if (m.type == CKEDITOR.NODE_ELEMENT) {
                ...
                if (m.equals(f))break;
                if (!k && (u = m.getName(),
                        "true" == m.getAttribute("contenteditable") ? k = m : !g && d[u] && (g = m), a[u])) {
                    if (u = !g && "div" == u) {
                        a:{
                            u = m.getChildren();
                            for (var e = 0, A = u.count(); e < A; e++) {
                                var r = u.getItem(e);
    ...
    CKEDITOR.dom.elementPath.prototype = {
        compare: function (a) {
            ...
            for (d = 0; d < g; d++)if (c(f[d]))return f[d];
            return null
    ...
    (function () {
        function a(a, c, d) {
            var g = a.serializable, k = c[d ? "endContainer" : "startContainer"], l = d ? "endOffset" : "startOffset",
                ...
                return {
                    getNextRange: function (k) {
                        ...
                        if (l && 1 < a.length) {
                            ...
                            if (k)for (var u = 0; a[g + u + 1];) {
                                var e = l.document;
                                k = 0;
                                m = e.getById(d[u].endNode);
                                for (e = e.getById(d[u + 1].startNode); ;) {
                                    m =
                                        m.getNextSourceNode(!1);
                                    if (e.equals(m)) k = 1; else if (c(m) || m.type == CKEDITOR.NODE_ELEMENT && m.isBlockBoundary())continue;
                                    break
                                }
                                if (!k)break;
                                u++
    ...
    (function () {
        ...
        function d(b) {
            ...
            if (c)for (var c = c.split(",").sort(function (a, b) {
                    return a > b ? -1 : 1
                           ...
                           g; f < c.length; f++)if (g = c[f], d.ie && (g.replace(/^ie/, "") == d.version || d.quirks && "iequirks" == g) && (g = "ie"), d[g]) {
                b += "_" + c[f];
                break
            }
        ...
        function f(a, b, c) {
            ...
            for (var k = 0; k < a.length; k++)if (CKEDITOR.env.webkit)for (f = 0; f < b.length; f++) {
                g = b[f][1];
                for (d = 0; d < c.length; d++)g = g.replace(c[d][0], c[d][1]);
                a[k].$.sheet.addRule(b[f][0], g)
            } else {
                g = b;
                for (d = 0; d < c.length; d++)g = g.replace(c[d][0], c[d][1]);
        ...
        var k = "cke_ui_color", l = [], m = /\$color/g;
            ...
            if (!CKEDITOR.env.ie || !CKEDITOR.env.quirks) {
                ...
                a = function (a) {
                    ...
                    if (!a.getById("cke_ui_color")) {
                        ...
                        l.push(a);
                        var d = b.getUiColor();
                        d && f([a], CKEDITOR.skin.chameleon(b, "panel"), [[m, d]])
                    }
                };
                b.on("panelShow", a);
                b.on("menuShow", a);
                ...
                labeledElement: function (b, a, d, f) {
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this,
                            b, a, d, function () {
                                for (var e = [], d = [], g = (a.id ? a.id : CKEDITOR.tools.getNextId()) + "_radio",
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function () {
                            ...
                            t(c);
                            for (var k = 0,
                                     l; k < a.items.length && (l = a.items[k]); k++)d.push('\x3coption value\x3d"', CKEDITOR.tools.htmlEncode(void 0 !== l[1] ? l[1] : l[0]).replace(/"/g, "\x26quot;"), '" /\x3e ', CKEDITOR.tools.htmlEncode(l[0]));
                            "undefined" != typeof c.inputStyle && (c.style = c.inputStyle);
    ...
    (function () {
        ...
        var J, z = {}, u, w = {}, Q = function (a) {
            ...
            for (var b in w) {
                for (var c = w[b],
                         d = c.length - 1; 0 <= d; d--)c[d].dialog != a && c[d].uiElement != a || c.splice(d, 1);
            ...
            CKEDITOR.ui.dialog = {
                uiElement: function (a, b, c, d, e, f, g) {
                    if (!(4 > arguments.length)) {
                        ...
                        for (var l = k["class"] && k["class"].split ? k["class"].split(" ") : [],
                                 n = 0; n < l.length; n++)l[n] && (r[l[n]] = 1);
                        l =
                            [];
                        for (n in r)l.push(n);
                        k["class"] = l.join(" ");
                ...
                if (c) {
                    ...
                    if (a == CKEDITOR.TRISTATE_OFF) {
                        ...
                        for (b = e.length - 1; 0 <= b; b--) {
                            ...
                            a:{
                                d = c;
                                for (var f = 0, m = d.getChildCount(),
                                         l = void 0; f < m && (l = d.getChild(f)); f++)if (l.type == CKEDITOR.NODE_ELEMENT && l.isBlockBoundary()) {
                                    d = !1;
                                    break a
                                }
                                d = !0
    ...
    CKEDITOR.plugins.add("menu", {
        requires: "floatpanel", beforeInit: function (g) {
            for (var h = g.config.menu_groups.split(","), p = g._.menuGroups = {}, n = g._.menuItems = {},
                     a = 0; a < h.length; a++)p[h[a]] = a + 1;
        ...
        CKEDITOR.menu = CKEDITOR.tools.createClass({
            $: function (a, b) {
                ...
                add: function (a) {
                    ...
                    g(e);
                    for (var d = l.elementPath(),
                             d = ['\x3cdiv class\x3d"cke_menu' + (d && d.direction() != l.lang.dir ? " cke_mixed_dir_content" : "") + '" role\x3d"presentation"\x3e'],
                             h = e.length, p = h && e[0].group, n = 0; n < h; n++) {
                        var q = e[n];
    ...
    (function () {
        function q(a, e) {
            ...
            a.on("selectionChange", function () {
                for (var c = [], d = k.list = [], g = [], b = k.filters, e = !0, l = a.elementPath().elements, f,
                         u = l.length; u--;) {
                    var h = l[u], r = 0;
    ...
    (function () {
        ...
        function l(a, c, d, b) {
            if (b && b.length)for (var e,
                                       g = b.length; g--;)if (e = b[g], "hbox" != e.type && "vbox" != e.type && "fieldset" != e.type || l(a, c, d, e.children), e.filebrowser)if ("string" == typeof e.filebrowser && (e.filebrowser = {
        ...
        CKEDITOR.on("dialogDefinition", function (a) {
            if (a.editor.plugins.filebrowser)for (var c = a.data.definition, d,
                                                      b = 0; b < c.contents.length; ++b)if (d = c.contents[b]) l(a.editor, a.data.name, c, d.elements), d.hidden && d.filebrowser && (d.hidden = !h(c, d.id, d.filebrowser))
        })
    })();
    (function () {
        function k(a) {
    ...
    CKEDITOR.plugins.add("format", {
        requires: "richcombo", init: function (a) {
            if (!a.blockless) {
                for (var f = a.config, c = a.lang.format, l = f.format_tags.split(";"), d = {}, m = 0, n = [],
                         g = 0; g < l.length; g++) {
        ...
        CKEDITOR.plugins.add("indent", {
            init: function (a) {
                ...
                a.on("dirChanged", function (b) {
                    ...
                    f.setStartBefore(l);
                    f.setEndAfter(l);
                    for (var n = new CKEDITOR.dom.walker(f),
                             c; c = n.next();)if (c.type == CKEDITOR.NODE_ELEMENT)if (!c.equals(l) &&
                        c.getDirection()) f.setStartAfter(c), n = new CKEDITOR.dom.walker(f); else {
                        var d = a.config.indentClasses;
                        if (d)for (var g = "ltr" == b.data.dir ? ["_rtl", ""] : ["", "_rtl"],
                                       h = 0; h < d.length; h++)c.hasClass(d[h] + g[0]) && (c.removeClass(d[h] + g[0]), c.addClass(d[h] + g[1]));
    ...
    (function () {
        function w(c) {
            function f(b) {
                ...
                for (var g = l.isIndent ? 1 : -1, a = e[0], e = e[e.length - 1],
                         k = CKEDITOR.plugins.list.listToArray(b, q), n = k[e.getCustomData("listarray_index")].indent,
                ...
                if (!l.isIndent) {
                    var f;
                    if ((f = b.getParent()) && f.is("li"))for (var g = e.listNode.getChildren(), r = [], m,
                                                                   a = g.count() - 1; 0 <= a; a--)(m = g.getItem(a)) && m.is && m.is("li") &&
                    r.push(m)
                }
            ...
            for (var l = this, q = this.database, p = this.context, n = c.getSelection(),
                     n = (n && n.getRanges()).createIterator(), d; d = n.getNextRange();) {
    ...
    (function () {
        ...
        CKEDITOR.plugins.link = {
            getSelectedLink: function (c) {
                ...
                for (var b = c.editable(), a = b.isInline() && !c.plugins.divarea ? c.document : b,
                         b = a.getElementsByTag("a"), a = a.getElementsByTag("img"), f = [], e = 0,
                         d; d = b.getItem(e++);)(d.data("cke-saved-name") || d.hasAttribute("name")) && f.push({
                ...
                a.match(t) && ("encode" == e ? a = a.replace(A, function (a, b, c) {
                    ...
                    return "mailto:" + String.fromCharCode.apply(String, b.split(",")) + c.replace(/\\'/g, "'")
                        ...
                        if (b == f.name) {
                            ...
                            b = /(^')|('$)/g;
                            c = c.match(/[^,\s]+/g);
                            for (var d = c.length, e, h,
                                     k = 0; k < d; k++)e = decodeURIComponent, h = c[k].replace(b, "").replace(/\\'/g, "'"), h = e(h), e = f.params[k].toLowerCase(), a[e] = h;
                ...
                if (b.target)if ("popup" == b.target.type) {
                    for (var a = ["window.open(this.href, '", b.target.name || "", "', '"],
                             h = "resizable status location toolbar menubar fullscreen scrollbars dependent".split(" "),
                             e = h.length, g = function (a) {
    ...
    (function () {
        ...
        function E(b, m, e, c) {
            for (var f,
                     g; f = b[c ? "getLast" : "getFirst"](J);)(g = f.getDirection(1)) !== m.getDirection(1) && f.setAttribute("dir", g), f.remove(), e ? f[c ? "insertBefore" : "insertAfter"](e) : m.append(f, c)
        }
            ...
            listToArray: function (b, m, e, c, f) {
                ...
                for (var g = 0, k = b.getChildCount(); g < k; g++) {
                    ...
                    if ("li" == h.$.nodeName.toLowerCase()) {
                        ...
                        e.push(d);
                        for (var a = 0, p = h.getChildCount(),
                                 l; a < p; a++)l = h.getChild(a), l.type == CKEDITOR.NODE_ELEMENT && v[l.getName()] ? CKEDITOR.plugins.list.listToArray(l, m, e, c + 1, d.grandparent) : d.contents.push(l)
                    }
                }
                return e
                ...
                for (var g, k = b[e].parent.getDocument(), h = new CKEDITOR.dom.documentFragment(k), d = null, a = e,
                         p = Math.max(b[e].indent, 0), l = null, q, n, t = c == CKEDITOR.ENTER_P ? "p" : "div"; ;) {
                    var r = b[a];
                    g = r.grandparent;
        ...
        B.prototype = {
            exec: function (b) {
                ...
                for (var m = e.createBookmarks(!0), f = [], k = {}, c = c.createIterator(),
                         h = 0; (g = c.getNextRange()) && ++h;) {
                    ...
                    for (g.forceBrBreak =
                        ...
                        for (var l = b.elementPath(d), a = l.elements, p = 0, l = l.blockLimit, q,
                                 n = a.length - 1; 0 <= n && (q = a[n]); n--)if (v[q.getName()] && l.contains(q)) {
    ...
    (function () {
        ...
        function U(a, c, d, b) {
            for (var e = c.getDocumentPosition(), f = {}, k = {}, h = {}, g = {},
                     l = y.length; l--;)f[y[l]] = parseInt(c.getComputedStyle.call(c, "border-" + y[l] + "-width"), 10) || 0, h[y[l]] = parseInt(c.getComputedStyle.call(c, "padding-" + y[l]), 10) || 0, k[y[l]] = parseInt(c.getComputedStyle.call(c, "margin-" + y[l]), 10) || 0;
            d && !b || N(a, b);
        ...
        var ha = function () {
            ...
            ia = function () {
                function a(a) {
                    ...
                    for (var b = Number.MAX_VALUE, h, g, l,
                             p; f && !f.equals(e) && (g = e.getNext(a.isRelevant));)h = Math.abs(ka(a, e, g) - a.mouse.y), h < b && (b = h, l = e, p = g), e = g, r(a, e);
                    ...
                    a.addCommand("maximize", {
                        ...
                        exec: function () {
                            ...
                            if (this.state == CKEDITOR.TRISTATE_OFF) {
                                ...
                                for (var d = [g, h],
                                         q = 0; q < d.length; q++)u(d[q], d[q].getCustomData("maximize_saved_styles")), d[q].removeCustomData("maximize_saved_styles");
    ...
    CKEDITOR.plugins.removeformat = {
        commands: {
            removeformat: {
                exec: function (a) {
                    for (var h = a._.removeFormatRegex || (a._.removeFormatRegex = new RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")),
                             e = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(",")),
                             f = CKEDITOR.plugins.removeformat.filter, m = a.getSelection().getRanges(),
                             n = m.createIterator(), p = function (a) {
                            return a.type == CKEDITOR.NODE_ELEMENT
                        }, c; c = n.getNextRange();) {
    ...
    CKEDITOR.plugins.add("scayt", {
        requires: "menubutton,dialog", tabToOpen: null, dialogName: "scaytDialog", init: function (a) {
            ...
            for (var b = a.config.scayt_contextMenuItemsOrder.split("|"),
                     e = 0; e < b.length; e++)b[e] = "scayt_" + b[e];
        ...
        CKEDITOR.plugins.add("stylescombo", {
            requires: "richcombo", init: function (c) {
                ...
                c.on("stylesSet", function (b) {
                    if (b = b.data.styles) {
                        for (var a, h, d, e = 0,
                                 n = b.length; e < n; e++)(a = b[e], c.blockless && a.element in CKEDITOR.dtd.$block || (h = a.name, a = new CKEDITOR.style(a), c.filter.customConfig && !c.filter.check(a))) || (a._name = h, a._.enterMode = l.enterMode, a._.type = d = a.assignedTo || a.type, a._.weight = e + 1E3 * (d == CKEDITOR.STYLE_OBJECT ? 1 : d == CKEDITOR.STYLE_BLOCK ? 2 : 3), f[h] =
                            a, k.push(a), m.push(a));
                        k.sort(function (a, b) {
    ...
    (function () {
        ...
        function p(e, d) {
            for (var b = t(e), c = b[0], a = c.getAscendant("table"), c = c.getDocument(), f = b[0].getParent(),
        ...
        function u(e) {
            if (e instanceof CKEDITOR.dom.selection) {
                ...
                for (var d = d[d.length - 1], a = d.getParent().$.rowIndex + d.$.rowSpan - 1, d = [],
                         f = e; f <= a; f++) {
        ...
        function m(e, d) {
            for (var b = t(e), c = b[0].getAscendant("table"), a = v(b, 1), b = v(b), a = d ? a : b,
        ...
        function A(e, d) {
            ...
            if (1 < k) {
                ...
                for (var k = Math.floor(k /
                        2), c = g + l, a = new CKEDITOR.dom.element(a.$.rows[c]), f = z(f, c), n, c = b.clone(),
                         g = 0; g < f.length; g++)if (n = f[g], n.parentNode == a.$ && g > h) {
        ...
        CKEDITOR.plugins.tabletools =
            {
                ...
                b("columnDelete", d({
                    requiredContent: "table", exec: function (a) {
                        ...
                        for (var d = CKEDITOR.tools.buildTableMap(a), e, l, n = [], r = 0,
                                 p = d.length; r < p; r++)for (var m = 0,
                                                                   u = d[r].length; m < u; m++)d[r][m] == b.$ && (e = m), d[r][m] == c.$ && (l = m);
    ...
    CKEDITOR.tools.buildTableMap = function (t) {
        ...
        for (var p = -1, u = [], v = 0; v < t.length; v++) {
            ...
            for (var m = -1, y = 0; y < t[v].cells.length; y++) {
                var x = t[v].cells[y];
                for (m++; u[p][m];)m++;
                for (var q = isNaN(x.colSpan) ? 1 : x.colSpan, x = isNaN(x.rowSpan) ? 1 : x.rowSpan,
                         z = 0; z < x; z++) {
                    u[p + z] || (u[p + z] = []);
            ...
            type: function (a, b) {
                ...
                if (!this.locked) {
                    ...
                    for (var b = this.index,
                             c = this.snapshots; 0 < b && this.currentImage.equalsContent(c[b - 1]);)--b;
