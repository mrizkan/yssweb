(function () {
    ...
    var l = ToolbarConfigurator.AbstractToolbarModifier, g = ToolbarConfigurator.FullToolbarEditor;
    ...
    e.prototype._createModifier = function (a) {
        function d(a) {
            ...
            if (null !== b.charsBetween) {
                var d =
                        k.getUnusedButtonsArray(k.actualConfig.toolbar, !0, b.charsBetween), e = a.getCursor(),
                    b = CodeMirror.Pos(e.line, e.ch - b.charsBetween.length), h = a.getTokenAt(e);
        ...
        function c(a, c) {
            ...
            b.charsBetween && (b.endChar = b.charsBetween[2], b.charsBetween = b.charsBetween[1].split("").reverse().join(""));
            return b
        }

        function b(a) {
            setTimeout(function () {
                a.state.completionActive || CodeMirror.showHint(a, d, {
        ...
        a = CKEDITOR.tools.isArray(a) ? "\tconfig.toolbar \x3d " + ("[\n\t\t" + g.map(a, function (a) {
        ...
        this.codeContainer.on("change", function () {
            var a = k.codeContainer.getValue(), a = k._evaluateValue(a);
            null !== a ? (k.actualConfig.toolbar = a.toolbar ? a.toolbar : k.actualConfig.toolbar,
    ...
    e.prototype._fillHintByUnusedElements = function () {
        var a = this.getUnusedButtonsArray(this.actualConfig.toolbar, !0), a = this.groupButtonNamesByGroup(a),
            d = g.map(a, function (a) {
            ...
            f = '\x3cdt class\x3d"list-header"\x3eToolbar group\x3c/dt\x3e\x3cdd class\x3d"list-header"\x3eUnused items\x3c/dd\x3e';
    ...
    e.prototype.getToolbarGroupByButtonName = function (a) {
        var d =
            this.fullToolbarEditor.buttonNamesByGroup, f;
    ...
    e.prototype.groupButtonNamesByGroup =
        function (a) {
            var d = [], f = JSON.parse(JSON.stringify(this.fullToolbarEditor.buttonNamesByGroup)), c;
            for (c in f) {
                var b = f[c], b = g.filter(b, function (b) {
    ...
    e.mapToolbarCfgToElementsList = function (a) {
        ...
        for (var f = [], c = a.length,
                 b = 0; b < c; b += 1)a[b] && "string" !== typeof a[b] && (f = f.concat(g.filter(a[b].items, d)));
        return f
    };
    ...
    e.prototype._mapToolbarGroupsToToolbar = function (a, d) {
        ...
        for (var f = a.length; f--;) {
            ...
            "separator" === a[f].type ? a[f] = "/" :
                CKEDITOR.tools.isArray(c) && 0 === c.length ? a.splice(f, 1) : a[f] = "string" == typeof c ? c : {
                    name: a[f].name,
                    items: c
                }
        }
    ...
    e.prototype._mapToolbarSubgroup = function (a, d) {
        ...
        for (var f = a.groups ? a.groups.length : 0, c = [], b = 0; b < f; b += 1) {
            var e = a.groups[b], e = this.fullToolbarEditor.buttonsByGroup["string" === typeof e ? e : e.name] || [],
                e = this._mapButtonsToButtonsNames(e, d), g = e.length, c = c.concat(e);
            g && c.push("-")
        }
        "-" == c[c.length - 1] && c.pop();
        return c
    };
    e.prototype._mapButtonsToButtonsNames = function (a,
                                                      d) {
        for (var f = a.length; f--;) {
            var c = a[f], c = "string" === typeof c ? c : this.fullToolbarEditor.getCamelCasedButtonName(c.name);
    ...
    e.prototype.mapToolbarToToolbarGroups = function (a) {
        ...
        for (var f = {}, c = [], b = [], c = a.length, e = 0; e < c; e++)if ("/" === a[e]) b.push("/"); else {
            var g = a[e].items, m = {};
            m.name = a[e].name;
            m.groups = [];
