...
var SF = function () {
    ...
    var b = {
        attachListener: function (a, e, b) {
            if (a.addEventListener) a.addEventListener(e, b, !1); else if (a.attachEvent) a.attachEvent("on" + e, function () {
                b.apply(a, arguments)
    ...
    b.getByClass = function () {
        ...
        return "function" === typeof a ? function (e, b) {
...
(function () {
    ...
    SF.modal = function (c) {
        ...
        c.modalStyles = d;
        c.closeStyles = d;
        var a = c.afterCreate, e = c.afterClose;
...
"use strict";
(function () {
    for (var d = SF.getByClass("tree-a"), c = d.length; c--;)SF.attachListener(d[c], "click", function (b) {
...
(function (d, c) {
    ...
    function a() {
        var a = [];
        return {
            watch: a.push.bind(a), trigger: function (b) {
                for (var c = !0, d = {
                    preventDefault: function () {
                        c = !1
                    }
                }, e = 0; e < a.length; e++)a[e](b, d);
                return c
            }
        }
    }
    ...
    function f(a, b) {
        return e.div().clazz("pico-overlay").clazz(a("overlayClass", "")).stylize({
            display: "block",
            position: "fixed",
            top: "0px",
            left: "0px",
            ...
            {opacity: .5, background: "#000"})).onClick(function () {
            a("overlayClose", !0) && b()
        })
    }
    ...
    function n(a, b) {
        ...
        return e.div().clazz("pico-content").clazz(a("modalClass", "")).stylize({
            display: "block",
            position: "fixed",
            zIndex: 10001,
            left: "50%",
        ...
        }).stylize(a("modalStyles",
            {
                ...
                padding: "20px",
                borderRadius: "5px"
            })).html(a("content")).attr("role", "dialog").onClick(function (a) {
    ...
    function k(c) {
        ...
        function r(a) {
            if (!t) {
                var c = n(e, q), b = f(e, q), d;
                d = e("closeButton", !0) ? c.child().html(e("closeHtml", "\x26#xD7;")).clazz("pico-close").clazz(e("closeClass")).stylize(e("closeStyles", {
                    borderRadius: "2px",
                    cursor: "pointer",
                    height: "15px",
                    width: "15px",
        ...
        var x = a(), y = a(), z = a(), w = a(), v = a(), t, m = r.bind(d,
            "modal"), l = r.bind(d, "overlay"), u = r.bind(d, "close"), h = {
            modalElem: p(m),
            closeElem: p(u),
            overlayElem: p(l),
            show: function () {
    ...
    e.prototype = {
        child: function () {
            ...
            a = a || {};
            "undefined" !== typeof a.opacity && (a.filter = "alpha(opacity\x3d" + 100 * a.opacity + ")");
    ...
    "function" === typeof d.define && d.define.amd ? d.define(function () {
        return k
    }) : d.picoModal = k
})(window, document);