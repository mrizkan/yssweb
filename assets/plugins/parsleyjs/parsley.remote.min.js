...
!function (a) {
    ...
    window.ParsleyExtend = window.ParsleyExtend || {}, window.ParsleyExtend = a.extend(!0, window.ParsleyExtend, {
        asyncSupport: !0,
        asyncValidators: {
            "default": {
                fn: function (a) {
        ...
        addAsyncValidator: function (a, b, c, d) {
            return this.asyncValidators[a.toLowerCase()] = {fn: b, url: c || !1, options: d || {}}, this
        },
        ...
        onSubmitValidate: function (b) {
            var c = this;
            if (!0 !== b.parsley)return this.submitEvent = a.extend(!0, {}, b), b instanceof a.Event && (b.stopImmediatePropagation(), b.preventDefault()), this._asyncValidateForm(void 0, b).done(function () {
                c._trigger("submit") && !c.submitEvent.isDefaultPrevented() && c.$element.trigger(a.extend(a.Event("submit"), {parsley: !0}))
            })
        },
        eventValidate: function (a) {
        ...
        _asyncValidateForm: function (b) {
            var c = this, d = [];
            this._refreshFields(), this._trigger("validate");
            for (var e = 0; e < this.fields.length; e++)b && b !== this.fields[e].options.group || d.push(this.fields[e]._asyncValidateField());
            return a.when.apply(a, d).done(function () {
                c._trigger("success")
            }).fail(function () {
                c._trigger("error")
            }).always(function () {
        ...
        _asyncIsValidForm: function (b, c) {
            var d = [];
            this._refreshFields();
            for (var e = 0; e < this.fields.length; e++)b && b !== this.fields[e].options.group || d.push(this.fields[e]._asyncIsValidField(c));
            return a.when.apply(a, d)
        },
        _asyncValidateField: function (a) {
            var b = this;
            return this._trigger("validate"), this._asyncIsValidField(a).done(function () {
                b._trigger("success")
            }).fail(function () {
                b._trigger("error")
            }).always(function () {
        ...
        _asyncIsValidField: function (b, c) {
            var d = a.Deferred();
            return !1 === this.isValid(b, c) ? d.rejectWith(this) : "undefined" != typeof this.constraintsByName.remote ? this._remote(d) : d.resolveWith(this), d.promise()
        },
        _remote: function (b) {
            var c, d, e = this, f = {}, g = this.options.remoteValidator || (!0 === this.options.remoteReverse ? "reverse" : "default");
            if (g = g.toLowerCase(), "undefined" == typeof this.asyncValidators[g])throw new Error("Calling an undefined async validator: `" + g + "`");
            f[this.$element.attr("name") || this.$element.attr("id")] = this.getValue(), this.options.remoteOptions = a.extend(!0, this.options.remoteOptions || {}, this.asyncValidators[g].options), c = a.extend(!0, {}, {
                url: this.asyncValidators[g].url || this.options.remote,
                data: f,
                type: "GET"
            }, this.options.remoteOptions || {}), d = a.param(c), "undefined" == typeof this._remoteCache && (this._remoteCache = {}), this._remoteCache[d] || (this._xhr && "pending" === this._xhr.state() && this._xhr.abort(), this._xhr = a.ajax(c), this._remoteCache[d] = this._xhr), this._remoteCache[d].done(function (a, c, d) {
                e._handleRemoteResult(g, d, b)
            }).fail(function (a, c) {
                "abort" !== c && e._handleRemoteResult(g, a, b)
            })
        },
        _handleRemoteResult: function (a, b, c) {
            return "function" == typeof this.asyncValidators[a].fn && this.asyncValidators[a].fn.call(this, b) ? void c.resolveWith(this) : (this.validationResult = [new window.ParsleyValidator.Validator.Violation(this.constraintsByName.remote, this.getValue(), null)], void c.rejectWith(this))
        }
