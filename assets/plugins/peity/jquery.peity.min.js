...
(function (k, w, h, v) {
    ...
    d.register("pie", {fill: ["#ff9900", "#fff4dd", "#ffc66e"], radius: 8}, function (a) {
        ...
        t || (e = 2, t = 1, b = [0, 1]);
        var l = 2 * a.radius, l = this.prepare(a.width || l, a.height || l), c = l.width(), f = l.height(), j = c / 2, d = f / 2, f = h.min(j, d), a = a.innerRadius;
        ...
        for (var r = h.PI, s = this.fill(), g = this.scale = function (a, b) {
            ...
            var u = b[c], i = u / t;
            if (0 != i) {
                if (1 == i)if (a)var i = j - 0.01, p = d - f, n = d - a, i = q("path", {d: ["M", j, p, "A", f, f, 0, 1, 1, i, p, "L", i, n, "A", a, a, 0, 1, 0, j, n].join(" ")}); else i = q("circle", {
                    cx: j,
                    cy: d,
                    r: f
