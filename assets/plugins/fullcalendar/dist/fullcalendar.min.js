...
!function (a) {
    ...
    function ja(a) {
        for (var b, c = [], d = /\[([^\]]*)\]|\(([^\)]*)\)|(LTS|LT|(\w)\4*o?)|([^\w\[\(]+)/g; b = d.exec(a);)b[1] ? c.push(b[1]) : b[2] ? c.push({maybe: ja(b[2])}) : b[3] ? c.push({token: b[3]}) : b[5] && c.push(b[5]);
        return c
    }
    ...
    function xa(a) {
        var b, c, d, e, f;
        for (b = 0; b < a.length; b++)for (c = a[b], d = 0; d < c.length; d++)for (e = c[d], e.forwardSegs = [], f = b + 1; f < a.length; f++)Aa(e, a[f], e.forwardSegs)
    }
    ...
    function za(a, b, c) {
        ...
        if (void 0 === a.forwardCoord)for (e.length ? (e.sort(Ca), za(e[0], b + 1, c), a.forwardCoord = e[0].backwardCoord) : a.forwardCoord = 1, a.backwardCoord = a.forwardCoord - (a.forwardCoord - c) / (b + 1), d = 0; d < e.length; d++)za(e[d], 0, a.forwardCoord)
    }
    ...
    function Da(c, d) {
        ...
        var S, T, U, V, W, X, Z, $, _ = O.isFetchNeeded, aa = O.fetchEvents, ba = c[0], ca = {}, da = 0, ea = [];
    ...
    function Ha(c) {
        ...
        function f(b, c) {
            g(b, function (d) {
                ...
                if (c == V) {
                    if (d)for (e = 0; e < d.length; e++)f = d[e], g = h ? f : s(f, b), g && X.push.apply(X, x(g));
                    W--, W || S(X)
                }
            })
        }
        ...
        function g(b, d) {
            ...
            if (i)a.isFunction(i) ? (M.pushLoading(), i.call(M, N.clone(), R.clone(), c.timezone, function (a) {
                ...
                if (j) {
                    ...
                    var o = a.extend({}, k || {}), p = Q(b.startParam, c.startParam), q = Q(b.endParam, c.endParam), r = Q(b.timezoneParam, c.timezoneParam);
        ...
        function x(b, c, d) {
            ...
            if (c = c || N, d = d || R, b)if (b._recurring) {
        ...
        function E(a, b) {
            var d = b.source || {}, e = Q(b.constraint, d.constraint, c.eventConstraint), f = Q(b.overlap, d.overlap, c.eventOverlap);
        ...
        function H(b, c, d, e) {
            ...
            if (b = a.extend({}, b), b.start = b.start.clone().stripZone(), b.end = b.end.clone().stripZone(), null != c) {
                for (f = J(c), g = !1, i = 0; i < f.length; i++)if (K(f[i], b)) {
                    g = !0;
                    break
                }
                if (!g)return !1
            }
            for (h = M.getPeerEvents(e, b), i = 0; i < h.length; i++)if (j = h[i], L(j, b)) {
                if (d === !1)return !1;
        ...
        function K(a, b) {
            var c = a.start.clone().stripZone(), d = M.getEventEnd(a).stripZone();
        ...
        var N, R, S = M.reportEvents, T = {events: []}, U = [T], V = 0, W = 0, X = [];
    ...
    var Ja = a.fullCalendar = {version: "2.3.2"}, Ka = Ja.views = {};
    ...
    var Na, Oa, Pa, Qa = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"], Ra = ["year", "month", "week", "day", "hour", "minute", "second", "millisecond"], Sa = {}.hasOwnProperty, Ta = /^\s*\d{4}-\d\d$/, Ua = /^\s*\d{4}-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?)?$/, Va = b.fn, Wa = a.extend({}, Va);
    Ja.moment = function () {
        return Z(arguments)
    ...
    var $a = ka.extend({
        ...
        dayMousedown: function (a) {
            var b, c, d = this, e = this.view, f = e.opt("selectable"), i = new cb(this.coordMap, {
        ...
        fillSegHtml: function (a, b) {
            var c = this[a + "SegClasses"], d = this[a + "SegCss"], e = c ? c.call(this, b) : [], f = T(d ? d.call(this, b) : {});
    ...
    fb.mixin({
        ...
        segDragMousedown: function (a, b) {
            var c, d = this, e = this.view, f = e.calendar, i = a.el, j = a.event, k = new db(a.el, {
                parentEl: e.el,
    ...
    gb.mixin({
        rowStructs: null, unrenderEvents: function () {
            ...
            var c, d, e = this.view, f = a.event, g = e.isEventDraggable(f), h = !b && f.allDay && a.isStart && e.isEventResizableFromStart(f), i = !b && f.allDay && a.isEnd && e.isEventResizableFromEnd(f), j = this.getSegClasses(a, g, h || i), k = T(this.getEventSkinCss(f)), l = "";
        ...
        segPopover: null, popoverSegs: null, removeSegPopover: function () {
            ...
            var d, e = this.view, f = e.opt("theme"), g = b.start.format(e.opt("dayPopoverFormat")), h = a('<div class="fc-header ' + e.widgetHeaderClass + '"><span class="fc-close ' + (f ? "ui-icon ui-icon-closethick" : "fc-icon fc-icon-x") + '"></span><span class="fc-title">' + R(g) + '</span><div class="fc-clear"/></div><div class="fc-body ' + e.widgetContentClass + '"><div class="fc-event-container"></div></div>'), i = h.find(".fc-event-container");
    ...
    var hb = fb.extend({
        ...
        processOptions: function () {
            var a = this.view, c = a.opt("slotDuration"), d = a.opt("snapDuration");
    ...
    hb.mixin({
        eventSkeletonEl: null, renderFgSegs: function (b) {
            ...
            var c, d, e, f = this.view, g = a.event, h = f.isEventDraggable(g), i = !b && a.isStart && f.isEventResizableFromStart(g), j = !b && a.isEnd && f.isEventResizableFromEnd(g), k = this.getSegClasses(a, h, i || j), l = T(this.getEventSkinCss(g));
    ...
    var ib = Ja.View = ka.extend({
        ...
        computeRange: function (a) {
            var b, c, d = E(this.intervalDuration), e = a.clone().startOf(d), f = e.clone().add(this.intervalDuration);
        ...
        getUnitViewSpec: function (b) {
            var c, d, e;
            if (-1 != a.inArray(b, Ra))for (c = this.header.getViewsWithButtons(), a.each(Ja.views, function (a) {
                c.push(a)
            }), d = 0; d < c.length; d++)if (e = this.getViewSpec(c[d]), e && e.singleUnit == b)return e
        },
        buildViewSpec: function (a) {
            for (var d, e, f, g, h = this.overrides.views || {}, i = [], j = [], k = [], l = a; l;)d = Ka[l], e = h[l], l = null, "function" == typeof d && (d = {"class": d}), d && (i.unshift(d), j.unshift(d.defaults || {}), f = f || d.duration, l = l || d.type), e && (k.unshift(e), f = f || e.duration, l = l || e.type);
    ...
    }, jb.englishDefaults = {dayPopoverFormat: "dddd, MMMM D"}, jb.rtlDefaults = {
        header: {
    ...
    var lb = {
        buttonText: function (a) {
            return {prev: S(a.prevText), next: S(a.nextText), today: S(a.currentText)}
    ...
    var ob = {dataType: "json", cache: !1}, pb = 1;
    ...
    Ka.basic = {"class": qb}, Ka.basicDay = {type: "basic", duration: {days: 1}}, Ka.basicWeek = {
        type: "basic",
        duration: {weeks: 1}
    }, Ka.month = {"class": rb, duration: {months: 1}, defaults: {fixedWeekCount: !0}};
    var sb = ib.extend({
        timeGrid: null,
        dayGrid: null,
        axisWidth: null,
    ...
    }, Ka.agendaDay = {type: "agenda", duration: {days: 1}}, Ka.agendaWeek = {type: "agenda", duration: {weeks: 1}}, Ja
});