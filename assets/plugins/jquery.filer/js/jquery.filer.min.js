...
!function (e) {
    ...
    e.fn.filer = function (i) {
        return this.each(function (t, n) {
            var l = e(n), a = ".jFiler", r = e(), o = e(), s = e(), d = [], f = e.isFunction(i) ? i(l, e.fn.filer.defaults) : i, p = f && e.isPlainObject(f) ? e.extend(!0, {}, e.fn.filer.defaults, f) : e.fn.filer.defaults, u = {
                init: function () {
                    ...
                    if (u._applyAttrSettings(), null != p.beforeRender && "function" == typeof p.beforeRender ? p.beforeRender(r, l) : null, p.theme && r.addClass("jFiler-theme-" + p.theme), "input" != l.get(0).tagName.toLowerCase() && "file" != l.get(0).type)o = l, l = e('<input type="file" name="' + p.name + '" />'), l.css({
                        ...
                        top: "-9999px",
                        "z-index": "-9999"
                    }), r.prepend(l), u._isGn = l; else if (p.changeInput) {
                        ...
                        l.after(o), l.css({position: "absolute", left: "-9999px", top: "-9999px", "z-index": "-9999"})
                    }
                    l.prop("jFiler").newInputEl = o, (!p.limit || p.limit && p.limit >= 2) && (l.attr("multiple", "multiple"), "[]" != l.attr("name").slice(-2) ? l.attr("name", l.attr("name") + "[]") : null), u._bindInput(), p.files && u._append(!1, {files: p.files}), null != p.afterRender && "function" == typeof p.afterRender ? p.afterRender(s, r, o, l) : null
                }, _clear: function () {
                    ...
                    switch (e) {
                        ...
                        case"props":
                            l.prop("jFiler") || l.prop("jFiler", {
                                ...
                                remove: function (e) {
                                    return u._remove(null, {binded: !0, data: {id: e}}), !0
                                },
                                reset: function () {
                    ...
                    for (var t = 0; t < u.files.length; t++) {
                        var n = u.files[t].name.split(".").pop().toLowerCase(), l = u.files[t], a = {
                            name: l.name,
                            size: l.size,
                    ...
                    create: function (i) {
                        var t = u.files[i], n = u._itFc ? u._itFc.id : i, l = t.name, a = t.size, r = t.type.split("/", 1).toString().toLowerCase(), o = -1 != l.indexOf(".") ? l.split(".").pop().toLowerCase() : "", d = p.uploadFile ? '<div class="jFiler-jProgressBar">' + p.templates.progressBar + "</div>" : "", f = {
                            id: n,
                            name: l,
                            size: a,
                            ...
                            icon2: u._thumbCreator.generateIcon({type: r, extension: o}),
                        ...
                        if (i.file && "image" == n.type) {
                            var l = '<img src="' + i.file + '" draggable="false" />', a = t.find(".jFiler-item-thumb-image.fi-loading");
                        ...
                        if (window.File && window.FileList && window.FileReader && "image" == n.type && n.size < 6e6) {
                            ...
                            r.onload = function (i) {
                                var l = '<img src="' + i.target.result + '" draggable="false" />', a = t.find(".jFiler-item-thumb-image.fi-loading");
                                e(l).error(function () {
                                    l = u._thumbCreator.generateIcon(n), t.addClass("jFiler-no-thumbnail"), a.removeClass("fi-loading").html(l)
                                }).load(function () {
                                    a.removeClass("fi-loading").html(l)
                            ...
                            var l = u._thumbCreator.generateIcon(n), a = t.find(".jFiler-item-thumb-image.fi-loading");
                        ...
                        if (1 == t[2]) {
                            ...
                            if (l) {
                                var a = e(n).appendTo("body"), r = a.css("box-shadow");
                        ...
                        if (s.length < 1) {
                            if (p.appendTo)var t = e(p.appendTo); else var t = r;
                    ...
                    var t = u._itFc.html, n = new FormData;
                    if (n.append(l.attr("name"), u._itFc.file, u._itFc.file.name ? u._itFc.file.name : !1), null != p.uploadFile.data && e.isPlainObject(p.uploadFile.data))for (var a in p.uploadFile.data)n.append(a, p.uploadFile.data[a]);
                    ...
                    if ((i || e.originalEvent.clipboardData || e.originalEvent.clipboardData.items) && (!i || e.originalEvent.dataTransfer || e.originalEvent.dataTransfer.items) && !u._clPsePre) {
                        var t = i ? e.originalEvent.dataTransfer.items : e.originalEvent.clipboardData.items, n = function (e, i, t) {
                            i = i || "", t = t || 512;
                        ...
                        if (t)for (var l = 0; l < t.length; l++)if (-1 !== t[l].type.indexOf("image") || -1 !== t[l].type.indexOf("text/uri-list")) {
                            if (i)try {
                    ...
                    if (u._set("feedback", u.files.length + u._itFl.length + " " + p.captions.feedback2), p.showThumbs)u._thumbCreator._box(); else for (var n = 0; n < u.files.length; n++)u.files[n]._choosed = !0, u._addToMemory(n), u._onSelect(n);
                    if (!p.uploadFile && p.addMore) {
                        var a = e('<input type="file" />'), f = l.prop("attributes");
                        e.each(f, function () {
                    ...
                    var n = parseInt("object" == typeof t ? t.attr("data-jfiler-index") : t), a = u._itFl.filter(function (e, i) {
                        return e.id == n
                    });
                    ...
                    var a = n.get(0).jfiler_id || n.attr("data-jfiler-index"), d = null, f = function (i) {
                        var n = r.find("input[name^='jfiler-items-exclude-']:hidden").first(), a = u._itFl[i], o = [];
                    ...
                    bytesToSize: function (e) {
                        ...
                        var i = 1e3, t = ["Bytes", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"], n = Math.floor(Math.log(e) / Math.log(i));
                        return (e / Math.pow(i, n)).toPrecision(3) + " " + t[n]
                    }, hasAttr: function (e, i) {
                        var i = i ? i : l, t = i.attr(e);
                            ...
                            case"string":
                                return i.replace(/\{\{fi-(.*?)\}\}/g, function (e, i) {
                                    return i = i.replace(/ /g, ""), i.match(/(.*?)\|limitTo\:(\d+)/) ? i.replace(/(.*?)\|limitTo\:(\d+)/, function (e, i, n) {
                                        var i = t[i] ? t[i] : "", l = i.substring(0, n);
