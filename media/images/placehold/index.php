...
function jaApplyBackground(&$im, $width, $height, $bgimage, $bg_type = 'resize')
{
    ...
    switch ($ext) {
        case 'gif':
            $imBg = imagecreatefromgif($bgimage);
            break;
        case 'png':
            $imBg = imagecreatefrompng($bgimage);
            break;
        case 'bmp':
        case 'wbmp':
            $imBg = imagecreatefromwbmp($bgimage);
            break;
        case 'jpg':
        case 'jpeg':
    ...
    <select name="bg_image">
        ...
        <?php if (count($aBgFiles)): ?>
            <?php foreach ($aBgFiles as $bg): ?>
                <option value="<?php echo $bg['path']; ?>" <?php if ($bg['path'] == $bg_image) {
                    echo 'selected="selected"';
                } ?>><?php echo $bg['path']; ?></option>
            <?php endforeach; ?>
        <?php endif; ?>
    </select>
    <span class="title">Position</span>
    <input type="radio" name="bg_type" value="resize" id="bg_type_resize" <?php if ($bg_type == 'resize') {
        echo 'checked="checked"';
    } ?> /> <label for="bg_type_resize">Center</label>
    <input type="radio" name="bg_type" value="crop" id="bg_type_crop" <?php if ($bg_type == 'crop') {
        echo 'checked="checked"';
    } ?> /> <label for="bg_type_crop">Fill</label>

    <span class="group">Text Color:</span><input type="text" name="txt_color" class="color"
                                                 value="<?php echo $txt_color; ?>"/>
