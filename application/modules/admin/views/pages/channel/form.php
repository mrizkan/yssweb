                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="active"> Channel <?= empty($obj->CountryId) ? "Create" : "Edit" ?> </li>
                        </ol>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="CountryTitle" name="form[ChannelTitle]"
                                                       value="<?= $obj->ChannelTitle ?>"
                                                       class="form-control">
                                                <?= form_error('form[ChannelTitle]') ?>
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label> Channel Default Image
                                                    <small> image size ( 50px * 50px ) [MUST]</small>
                                                </label>
                                            </div>
