                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="active"> Product <?= empty($obj->ProductId) ? "Create" : "Edit" ?> </li>
                        </ol>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="form[BrandId]">.
                                                    ...
                                                    <?php foreach ($brands as $brand): ?>
                                                        <option
                                                                value="<?= $brand->BrandId ?>" <?= set_value('form[CategoryId]', $obj->CategoryId) == $brand->BrandId ? "selected" : "" ?> > <?= $brand->BrandTitle ?> </option>
                                                    <?php endforeach; ?>
                                                </select>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="ModelNumber" name="form[ModelNumber]"
                                                       value="<?= set_value('form[ModelNumber]', $obj->ModelNumber) ?>"
                                                       class="form-control">
                                                <?= form_error('form[ModelNumber]') ?>
                                            </div>
