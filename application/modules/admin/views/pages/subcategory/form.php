                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="active"> Sub Category <?= empty($obj->ProductId) ? "Create" : "Edit" ?> </li>
                        </ol>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="PriceRangeFrom" name="form[SubCategoryTitle]"
                                                       value="<?= set_value('form[SubCategoryTitle]', $obj->SubCategoryTitle) ?>"
                                                       class="form-control">
                                                <?= form_error('form[SubCategoryTitle]') ?>
