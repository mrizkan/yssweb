                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li><a href="<?= base_url('admin/channeltag') ?>"> Category</a></li>
                            <li class="active"> Category <?= empty($obj->ChannelTagId) ? "Create" : "Edit" ?> </li>
                        </ol>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="name">Channel Tag Name </label>
                                                <input type="text" id="ChannelTagTitle" name="form[ChannelTagTitle]"
                                                       value="<?= $obj->ChannelTagTitle ?>"
                                                       class="form-control">
                                                <?= form_error('form[ChannelTagTitle]') ?>
                                            </div>
                                        ...
                                        <div class="col-lg-6" style="display: none">
                                            <div class="form-group">
                                                <label> Category Default Image
                                                    <small> image size ( 870px * 240px )</small>
                                                </label>
                                            </div>
