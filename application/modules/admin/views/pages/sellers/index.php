        ...
        <div class="container">
                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="active"> Sellers List</li>
                        </ol>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card-box">
                        <h4 class="header-title m-t-0 m-b-30">Seller Details</h4>
                            ...
                            <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-12">
                                <table id="datatable" class=" table table-striped ">
                                    ...
                                    <?php foreach ($records as $k => $row): ?>
                                        <tr>
                                            <td> <?= $k + 1 ?>  </td>
                                            <td> <?= $row->Title . $row->SellerTitle ?> </td>
                                            <td> <?= $row->Email ?> </td>
                                            <td> <?= $row->Address ?> </td>
                                            <td> <?= $row->Telephone ?> </td>
                                            <td class="text-center">
                                                <a href="<?= current_url() . "/edit/$row->SellerId" ?>"
                                                   class="btn btn-warning fa fa-edit "> Edit </a>
                                                <a href="<?= current_url() . "/delete/$row->SellerId" ?>"
