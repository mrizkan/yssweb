            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Media Company</h4>
                        <ol class="breadcrumb p-0">
                            <li><a href="<?= base_url('admin') ?>">Dashboard</a></li>
                            <li><a href="<?= base_url('admin/company') ?>"> Media Company</a></li>
                            <li class="active"> Channel <?= empty($obj->MediaComId) ? "Create" : "Edit" ?> </li>
                        </ol>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="CountryTitle" name="form[MediaComTitle]"
                                                       value="<?= $obj->MediaComTitle ?>"
                                                       class="form-control">
                                                <?= form_error('form[MediaComTitle]') ?>
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label> Media Company Default Image
                                                    <small> image size ( 50px * 50px )</small>
                                                </label>
                                            </div>
