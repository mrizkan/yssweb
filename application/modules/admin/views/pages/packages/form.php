                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="active"> Packages <?= empty($obj->ProductId) ? "Create" : "Edit" ?> </li>
                        </ol>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="form[MediaComId]">.
                                                    <option value=""> Select Service Provider Name</option>
                                                    <?php foreach ($companies as $company): ?>
                                                        <option
                                                                value="<?= $company->MediaComId ?>" <?= set_value('form[MediaComId]', $obj->MediaComId) == $company->MediaComId ? "selected" : "" ?> > <?= $company->MediaComTitle ?> </option>
                                                    <?php endforeach; ?>
                                                </select>
                                                <?= form_error('form[MediaComId]') ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="ModelNumber" name="form[PackagesTitle]"
                                                       value="<?= set_value('form[PackagesTitle]', $obj->PackagesTitle) ?>"
                                                       class="form-control">
                                                <?= form_error('form[PackagesTitle]') ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="ModelNumber" name="form[Price]"
                                                       value="<?= set_value('form[Price]', $obj->Price) ?>"
                                                       class="form-control">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for="name">Channel URL
                                                </label>
                                                <input type="text" id="ModelNumber" name="form[URL]"
