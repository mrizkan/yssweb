        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card-box">
                        <h4 class="header-title m-t-0 m-b-30">Packages Details</h4>
                                ...
                                <table id="datatable" class=" table table-striped ">
                                    ...
                                    <?php foreach ($records as $k => $row): ?>
                                        <tr>
                                            ...
                                            <td> <?= $row->PackagesTitle ?>  </td>
                                            <td class="text-center">

                                                <!--<a href="<? /*= current_url() . "/add_channel/$row->PackagesId" */ ?>"
                                                   class="btn btn-info fa fa-tv "> Add Channel </a>-->

                                                <a href="<?= current_url() . "/edit/$row->PackagesId" ?>"
                                                   class="btn btn-warning fa fa-edit "> Edit </a>
                                                <a href="<?= current_url() . "/delete/$row->PackagesId" ?>"
