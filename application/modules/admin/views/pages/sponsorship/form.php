                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="active"> Sponsorship <?= empty($obj->SponsorshipId) ? "Create" : "Edit" ?> </li>
                        </ol>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    <div class="form-group">
                                                        <label for="name">Sponsorship Title </label>
                                                        <input type="text" id="EventTitle" name="form[SponsorshipTitle]"
                                                               value="<?= $obj->SponsorshipTitle ?>"
                                                               class="form-control">
                                                        <?= form_error('form[SponsorshipTitle]') ?>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label> Sponsorship Default Image
