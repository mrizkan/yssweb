                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="active"> Country <?= empty($obj->CountryId) ? "Create" : "Edit" ?> </li>
                        </ol>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="CountryTitle" name="form[CountryTitle]"
                                                       value="<?= $obj->CountryTitle ?>"
                                                       class="form-control">
                                                <?= form_error('form[CountryTitle]') ?>
                                            </div>
