                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li><a href="<?= base_url('admin/winner') ?>"> Winner</a></li>
                            <li class="active"> Winner <?= empty($obj->WinnerId) ? "Create" : "Edit" ?> </li>
                        </ol>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="WinnerTitle" name="form[WinnerTitle]"
                                                       value="<?= $obj->WinnerTitle ?>"
                                                       class="form-control">
                                            </div>
                                            <div class="form-group">
