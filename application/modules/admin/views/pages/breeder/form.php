                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li><a href="<?= base_url('admin/breeder') ?>"> Breeder</a></li>
                            <li class="active"> Breeder <?= empty($obj->BreederId) ? "Create" : "Edit" ?> </li>
                        </ol>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <label for="name">Breeder Name 1 </label>
                                                <input type="text" id="BreederTitle" name="form[BreederTitle]"
                                                       value="<?= $obj->BreederTitle ?>"
                                                       class="form-control">
                                            </div>
                                            <div class="form-group">
