            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">IP Tv</h4>
                        <ol class="breadcrumb p-0">
                            <li><a href="<?= base_url('admin') ?>">Dashboard</a></li>
                            <li><a href="<?= base_url('admin/iptv') ?>"> IP Tv</a></li>
                            <li class="active"> IP Tv <?= empty($obj->IptvId) ? "Create" : "Edit" ?> </li>
                        </ol>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="name">IP Tv Title </label>
                                                <input type="text" id="ModelNumber" name="form[IptvTitle]"
                                                       value="<?= set_value('form[IptvTitle]', $obj->IptvTitle) ?>"
                                                       class="form-control">
                                                <?= form_error('form[IptvTitle]') ?>
                                            </div>
                                        </div>
