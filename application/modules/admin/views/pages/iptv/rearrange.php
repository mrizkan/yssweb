        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">IP Tv Re-arrange</h4>
                        <ol class="breadcrumb p-0">
                            <li><a href="<?= base_url('admin') ?>">Dashboard</a></li>
                            <li><a href="<?= base_url('admin/iptv') ?>"> IP Tv</a></li>
                            <li class="active"> IP Tv Re-arrange</li>
                        </ol>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card-box">
                        <h4 class="header-title m-t-0 m-b-30">IP Tv Re-arrange</h4>

                        <p id="status"></p>

                        <input type="hidden" id="view" value="iptv"/>
                        <input type="hidden" id="id" value="IptvId"/>
                            ...
                            if (is_array($records)):
                                foreach ($records as $k => $row):
                                    ...
                                    <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-4"
                                         id="conid_<?= $row->IptvId ?>">
                                        <div class="alert alerts-demo" role="alert" style="cursor: move">
                                            <strong> Order No :</strong><?= $row->Order ?><br/>
                                            <strong> Country :</strong><?= $row->CountryTitle ?><br/>
                                            <strong> IP Tv Title :</strong><?= $row->IptvTitle ?>
                                        </div>
