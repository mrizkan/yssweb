        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">News Re-arrange</h4>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card-box">
                        <h4 class="header-title m-t-0 m-b-30">News Re-arrange</h4>

                        <p id="status"></p>

                        <input type="hidden" id="view" value="news"/>
                        <input type="hidden" id="id" value="NewsId"/>
