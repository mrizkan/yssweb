        ...
        <div class="container">
                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="active"> Garments List</li>
                        </ol>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card-box">
                        <h4 class="header-title m-t-0 m-b-30">Garments Details</h4>
                                    ...
                                    <?php foreach ($records as $k => $row): ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?= current_url() . "/edit/$row->GarmentId" ?>"
                                                   class="btn btn-warning fa fa-edit "> Edit </a>
                                                <a href="<?= current_url() . "/delete/$row->GarmentId" ?>"
