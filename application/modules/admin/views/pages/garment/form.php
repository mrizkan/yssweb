            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Garments</h4>
                        <ol class="breadcrumb p-0">
                            <li><a href="<?= base_url('admin') ?>">Dashboard</a></li>
                            <li><a href="<?= base_url('admin/garments') ?>"> Garments</a></li>
                            <li class="active"> Garments <?= empty($obj->OfferId) ? "Create" : "Edit" ?> </li>
                        </ol>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="form[CategoryId]">.
                                                    ...
                                                    <?php
                                                    if ($obj->CategoryId == 1) { ?>
                                                        <option value="1" selected> Promotional Item</option>
                                                        <option value="2"> Sport Item</option>
                                                        <?php
                                                    } elseif ($obj->CategoryId == 2) { ?>
                                                        <option value="1"> Promotional Item</option>
                                                        <option value="2" selected> Sport Item</option>
                                                        <?php
                                                    } else { ?>
                                                        <option value="1"> Promotional Item</option>
                                                        <option value="2"> Sport Item</option>
                                        ...
                                        <div class="col-lg-9">
                                            <div class="form-group">
                                                <label for="name">ProductTitle </label>
                                                <input type="text" id="ModelNumber" name="form[ProductTitle]"
                                                       value="<?= set_value('form[ProductTitle]', $obj->ProductTitle) ?>"
                                                       class="form-control">
                                                <?= form_error('form[ProductTitle]') ?>
                                            </div>
                                        </div>
