        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card-box">
                        <h4 class="header-title m-t-0 m-b-30">Advertisement Details</h4>
                                ...
                                <table id="datatable" class=" table table-striped ">
                                    ...
                                    <?php foreach ($locations as $location): $location = (object)$location; ?>
                                        <?php foreach ($records as $k => $row): ?>
                                            <?php
                                            if ($location->index == $row->LocationId) {
                                                ?>
                                                <tr>
                                                    <td> <?= $k + 1 ?>  </td>
                                                    <td> <?= $row->AddTitle ?>  </td>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?= current_url() . "/edit/$row->AddId" ?>"
                                                           class="btn btn-warning fa fa-edit "> Edit </a>
                                                        <a href="<?= current_url() . "/delete/$row->AddId" ?>"
