                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="active"> Video <?= empty($obj->VideoId) ? "Create" : "Edit" ?> </li>
                        </ol>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="EventTitle" name="form[VideoTitle]"
                                                               value="<?= $obj->VideoTitle ?>"
                                                               class="form-control">
                                                        <?= form_error('form[VideoTitle]') ?>
                                                    </div>
                                                </div>
                                            </div>
