                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="active"> Data Bank <?= empty($obj->BankId) ? "Create" : "Edit" ?> </li>
                        </ol>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    <div class="form-group">
                                                        <label for="name">Data Bank Name </label>
                                                        <input type="text" id="EventTitle" name="form[BankTitle]"
                                                               value="<?= $obj->BankTitle ?>"
                                                               class="form-control">
                                                        <?= form_error('form[BankTitle]') ?>
                                                    </div>
                                                </div>
                                            </div>
