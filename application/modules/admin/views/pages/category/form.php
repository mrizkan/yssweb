                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="active"> Category <?= empty($obj->CategoryId) ? "Create" : "Edit" ?> </li>
                        </ol>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="CategoryTitle" name="form[CategoryTitle]"
                                                       value="<?= $obj->CategoryTitle ?>"
                                                       class="form-control">
                                                <?= form_error('form[CategoryTitle]') ?>
                                            </div>
