        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Category Re-arrange</h4>
                        <ol class="breadcrumb p-0">
                            <li><a href="<?= base_url('admin') ?>">Dashboard</a></li>
                            <li><a href="<?= base_url('admin/Category') ?>"> Category</a></li>
                            <li class="active"> Category Re-arrange</li>
                        </ol>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card-box">
                        <h4 class="header-title m-t-0 m-b-30">Category Re-arrange</h4>

                        <p id="status"></p>

                        <input type="hidden" id="view" value="category"/>
                            ...
                            if (is_array($record)):
                                foreach ($record as $k => $row):
                                    ...
                                    <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-4"
                                         id="conid_<?= $row->CategoryId ?>">
                                        <div class="alert alerts-demo" role="alert" style="cursor: move">
                                            <strong> <?= $row->Order ?></strong> <?= $row->CategoryTitle ?>
                                        </div>
                                    </div>
