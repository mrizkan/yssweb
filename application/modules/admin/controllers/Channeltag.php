...
class Channeltag extends MY_Controller
{
    var $page = "channeltag";
    var $img_width = 870;
    var $img_height = 240;
    ...
    {
        parent::__construct();
        $this->load->model('Channel_Tag_model', 'model');
    ...
    function _form(&$d, $_id = 0)
    {
        ...
        $this->form_validation->set_rules("form[ChannelTagTitle]", "Channel Tag Title", "required");
