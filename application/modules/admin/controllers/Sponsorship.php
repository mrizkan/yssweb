...
{
    var $page = "sponsorship";

    function __construct()
    {
        parent::__construct();
        $this->load->model('Sponsorship_model', 'model');
    ...
    function _form(&$d, $_id = 0)
    {
        ...
        $this->form_validation->set_rules("form[SponsorshipTitle]", "Sponsorship Title", "required");
        $this->form_validation->set_rules("form[Image]", "Sponsorship Image", "required");
