...
class Company extends MY_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('Media_company_model', 'model');
    ...
    function _form(&$d, $_id = 0)
    {
        ...
        $this->form_validation->set_rules("form[MediaComTitle]", "Service Provider Name", "required");
        $this->form_validation->set_rules("form[Image]", "Service Provider Image", "required");
