 ...
 * Time: 11:09 AM
 */
class Photogallery extends Front_Controller
{
...
//  ============================================================================
        $config["base_url"] = base_url() . "Photo-Gallery/";
        $config["total_rows"] = $this->gallery->count_by([]);
//        p($this->db->last_query());
        $config["per_page"] = 8;
        ...
        $d['photos'] = $this->gallery->order_by("Order", "ASC")->limit($config["per_page"], ($page - 1) * 5)->get_all();
