 ...
 * Time: 11:09 AM
 */
class Comproject extends Front_Controller
{
    ...
    function index()
    {
        $d['count'] = $this->project->count_by(['Color' => '2']);
...
//        ============================================================================
        $config["base_url"] = base_url() . "Completed-Projects/";
        $config["total_rows"] = $this->project->count_by(['Color' => '2']);
//        p($this->db->last_query());
        $config["per_page"] = 8;
...
//        $d['projects'] = $this->project->order_by("Order", "ASC")->limit($config["per_page"],($page-1)*5)->get_all();
        $d['projects'] = $this->project->order_by("Order", "ASC")->limit($config["per_page"], ($page - 1) * 8)->get_many_by(['Color' => '2']);
