<!DOCTYPE html>
<html lang="en">
<title>News Updates of YSS Foundation</title>
...
<div id="page">
    ...
    <section class="page-section">
        <div class="container">
            <div class="row">
                <?php
                $sql2 = "SELECT * FROM news WHERE active='1' ORDER BY id DESC";
                ...
                while ($row = mysql_fetch_assoc($result2)) { ?>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="post-item">
                            ...
                            <h2 class="post-title">
                                <a href="news_details.php?id=<?php echo $row['id']; ?>"><?php echo $row['title']; ?></a>
                            </h2>
