...
<div class="page-header">
    <div class="container">
        <h1 class="title">Blog Grid 4 Column</h1>
    </div>
    <div class="breadcrumb-box">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="active">Blog Grid 4 Column</li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-sm-4 col-md-3">
                <div class="post-item">
                    <div class="video-container embed-container">
                        <p class="video-box">
                            <iframe class="fitvids" src="https://player.vimeo.com/video/56755157" style="width: 100%;" height="200"></iframe>
                        </p>
                    </div>
                    <h2 class="post-title">
