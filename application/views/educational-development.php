<!DOCTYPE html>
<html lang="en">
<title>Educational Development of YSS Foundation</title>
...
<div id="page">
    ...
    <div class="page-header">
        <div class="container">
            <h1 class="title">Educational Development</h1>
        </div>
    ...
    <section class="page-section">
        <div class="container">
            <div class="row">
                ...
                <?php
                $sql2 = "SELECT * FROM education WHERE active='1' ORDER BY id DESC";
                ...
                while ($row = mysql_fetch_assoc($result2)) { ?>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="post-item">
                            ...
                            <h2 class="post-title">
                                <a href="education_details.php?id=<?php echo $row['id']; ?>"><?php echo $row['title']; ?></a>
                            </h2>
